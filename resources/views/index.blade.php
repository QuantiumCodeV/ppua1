...
<html>
  <head>
    ...
    <title>Pumble™ - FREE Chat & Communication App for Teams</title>
    <!-- JSON-LD Schema -->
    ...
    <meta
      name="description"
      content="Business communication and team messaging software. Unlimited users, direct and group messages, and unlimited message history."
    />
    <meta
      name="image"
    ...
    <meta
      itemprop="name"
      content="Pumble™ - FREE Chat & Communication App for Teams"
    />
    <meta
    ...
    <meta
      property="og:title"
      content="Free Chat & Communication App for Teams - Pumble"
    />
    <meta
    ...
    <link
      ...
      fetchpriority="high"
      as="image"
      href="assets/images/redesign/homepage-video-cover@2048w.png"
      type="image/png"
    />
  ...
  <body id="home" class="homepage redsn main_grid">
    <header
      class="full-screen bg-overlay header-page main-header-page h-100 redsn-pb-lg-400 header-page--primary-color-links"
    >
      <style>
        ...
        <div class="container breakout">
          ...
          <div class="buttons navbar-nav ml-auto nav-right">
            <div class="navbar-nav nav-right xs-hidden bg-transparent">
              <a href="/login.html" class="nav-link nav-link-primary mr-2"
                >Log In</a
              >
            </div>
            <div class="navbar-nav nav-right xs-hidden bg-transparent">
      ...
      <div class="header-content m-0 @@class">
        <div class="text">
          <h1 class="clr-text-500 redsn-mb-75">
            The all-in-one<br />
            team communication app
          </h1>
          <p class="headline clr-text-400 redsn-my-100">
            Send messages and files to team members, easily find them with
            unlimited messages history, and start video conferencing with one
            click.
          </p>
          ...
          <div class="text-center mt-1 redsn-mb-200">
            ...
            >
              <div
                id="pmbl-social-proof-content"
                class="sm-flex-column"
                style="
                  display: none;
                  align-items: center;
            ...
            <script>
              (() => {
                fetch(
                  "https://pumble.com/public-assets/analytics/social-proof.json"
                )
                  ...
                  .then((socialProof) => {
                    ...
                    document.getElementById(
                      "pmbl-social-proof-value"
                    ).innerText = (+socialProof.value).toLocaleString();
                    document.getElementById(
                      "pmbl-social-proof-label"
                    ).innerText = label;
                    document.getElementById(
                      "pmbl-social-proof-content"
                    ).style.display = "flex";
                  })
                  .catch((e) => {
      ...
      <div
        class="video-section breakout header-app-screen-wrapper w-100 mw-100 redsn-mb-md-100 position-relative"
      >
        <!-- TODO: set dynamic src -->
        <!-- TODO: random set id -->
        <!-- TODO: optimise js script -->
    ...
    >
      <h2 class="section-title @@title_css">Your team communication hub</h2>

      <p class="headline @@sub_css">
        Start channels, share documents, organize video calls, and invite
          ...
          <div class="cards">
            ...
            >
              ...
              <div class="content">
                ...
                <p>Send 1-on-1 and group messages.</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="content">
                ...
                <p>Organize work conversation by topic.</p>
              </div>
            </div>

            <div id="card_thread" class="redsn_card icon_card card_zoom_effect">
              <img
                class="icon"
              ...
              <div class="content">
                ...
                <p>Spin-off discussions into threads.</p>
              </div>
            </div>

            <div id="card_files" class="redsn_card icon_card card_zoom_effect">
              <img
                class="icon"
                src="assets/images/icons/file-browser.svg"
                alt="card icon"
              />
              ...
              <div class="content">
                ...
                <p>Share files, images, and links with team.</p>
              </div>
            </div>
          </div>
          ...
          <div class="cards">
            ...
            >
              ...
              <div class="content">
                ...
                <p>Organize video meetings with teammates.</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="content">
                ...
                <p>Have a quick call with others.</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="content">
                ...
                <p>Create a link and send it to anyone.</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="content">
                ...
                <p>Present demos and provide support.</p>
              </div>
            </div>
          </div>
        ...
        <div class="section__row__column content">
          ...
          <div class="cards">
            ...
            >
              <img
                class="icon"
                src="assets/images/icons/manage_search.svg"
                alt="card icon"
              />

              <div class="content">
                <h3>Unlimited search</h3>

                <p>Find any message, whenever it happened.</p>
              </div>
            </div>

            <div id="card_guests" class="redsn_card icon_card card_zoom_effect">
              <img
                class="icon"
              ...
              <div class="content">
                ...
                <p>Give limited access to external people.</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="content">
                ...
                <p>Stay updated, mute when you need focus.</p>
              </div>
            </div>
            ...
            >
              <img
                class="icon"
                src="assets/images/icons/mentions.svg"
                alt="card icon"
              />
              ...
              <div class="content">
                ...
                <p>Get attention in group discussions.</p>
              </div>
            </div>
          </div>
    ...
    <section
      id="tabs1"
      class="section-tabs breakout card redsn-mt-400 clr-bg-500"
    >
      <h2 class="section-title @@title_css">Packed with Useful Features</h2>

      <p class="headline redsn-mb-400">
        From integrations to security, Pumble has everything a modern team
        needs.
      </p>
      ...
      <div class="tabs-container">
        <div class="tabs">
          <div id="integrations" class="tab active">
            ...
            >
              <path
                d="M29.9975 19.467V27.2003C29.9975 27.3054 29.9768 27.4094 29.9366 27.5065C29.8964 27.6035 29.8374 27.6917 29.7632 27.766C29.6889 27.8403 29.6007 27.8992 29.5036 27.9394C29.4066 27.9796 29.3025 28.0003 29.1975 28.0003H24.1308C24.0258 28.0003 23.9217 27.9796 23.8247 27.9394C23.7276 27.8992 23.6394 27.8403 23.5651 27.766C23.4908 27.6917 23.4319 27.6035 23.3917 27.5065C23.3515 27.4094 23.3308 27.3054 23.3308 27.2003V19.467C23.3308 19.3619 23.3515 19.2579 23.3917 19.1608C23.4319 19.0638 23.4908 18.9756 23.5651 18.9013C23.6394 18.827 23.7276 18.7681 23.8247 18.7279C23.9217 18.6877 24.0258 18.667 24.1308 18.667H29.1975C29.3025 18.667 29.4066 18.6877 29.5036 18.7279C29.6007 18.7681 29.6889 18.827 29.7632 18.9013C29.8374 18.9756 29.8964 19.0638 29.9366 19.1608C29.9768 19.2579 29.9975 19.3619 29.9975 19.467Z"
                stroke="#1D272C"
                stroke-width="2"
              />
              <path
                d="M9.99748 12.133V19.8663C9.99748 20.0785 9.91319 20.282 9.76316 20.432C9.61313 20.5821 9.40965 20.6663 9.19748 20.6663H4.13081C3.91864 20.6663 3.71515 20.5821 3.56513 20.432C3.4151 20.282 3.33081 20.0785 3.33081 19.8663V12.133C3.33081 11.9208 3.4151 11.7174 3.56513 11.5673C3.71515 11.4173 3.91864 11.333 4.13081 11.333H9.19748C9.40965 11.333 9.61313 11.4173 9.76316 11.5673C9.91319 11.7174 9.99748 11.9208 9.99748 12.133Z"
                stroke="#1D272C"
                stroke-width="2"
              />
              <path
                d="M29.9975 4.8V12.5333C29.9975 12.6384 29.9768 12.7424 29.9366 12.8395C29.8964 12.9365 29.8374 13.0247 29.7632 13.099C29.6889 13.1733 29.6007 13.2322 29.5036 13.2724C29.4066 13.3126 29.3025 13.3333 29.1975 13.3333H24.1308C24.0258 13.3333 23.9217 13.3126 23.8247 13.2724C23.7276 13.2322 23.6394 13.1733 23.5651 13.099C23.4908 13.0247 23.4319 12.9365 23.3917 12.8395C23.3515 12.7424 23.3308 12.6384 23.3308 12.5333V4.8C23.3308 4.69494 23.3515 4.59091 23.3917 4.49385C23.4319 4.39679 23.4908 4.3086 23.5651 4.23431C23.6394 4.16003 23.7276 4.1011 23.8247 4.0609C23.9217 4.02069 24.0258 4 24.1308 4H29.1975C29.3025 4 29.4066 4.02069 29.5036 4.0609C29.6007 4.1011 29.6889 4.16003 29.7632 4.23431C29.8374 4.3086 29.8964 4.39679 29.9366 4.49385C29.9768 4.59091 29.9975 4.69494 29.9975 4.8Z"
                stroke="#1D272C"
                stroke-width="2"
              />
              <path
                d="M23.3306 23.3337H18.664C17.9567 23.3337 17.2785 23.0527 16.7784 22.5526C16.2783 22.0525 15.9973 21.3742 15.9973 20.667V11.3337C15.9973 10.6264 16.2783 9.94814 16.7784 9.44804C17.2785 8.94794 17.9567 8.66699 18.664 8.66699H23.3306"
                stroke="#1D272C"
                stroke-width="2"
              />
              <path d="M15.9973 16H9.99731" stroke="#1D272C" stroke-width="2" />
            </svg>
          ...
          <div id="external" class="tab">
            ...
            >
              ...
              />
              <path
                d="M13.332 18.6668L26.6654 5.3335"
                stroke="#1D272C"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M18.668 18.6665L13.0013 18.6665L13.0013 12.9998"
                stroke="#1D272C"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div id="calendar" class="tab">
            ...
            >
              <path
                d="M26 5H6C5.20435 5 4.44129 5.31607 3.87868 5.87868C3.31607 6.44129 3 7.20435 3 8V26C3 26.7957 3.31607 27.5587 3.87868 28.1213C4.44129 28.6839 5.20435 29 6 29H26C26.7957 29 27.5587 28.6839 28.1213 28.1213C28.6839 27.5587 29 26.7957 29 26V8C29 7.20435 28.6839 6.44129 28.1213 5.87868C27.5587 5.31607 26.7957 5 26 5Z"
                stroke="#673AB7"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              ...
              />
              <path
                d="M19 16.2505L21.7133 14.2505H22V24.7492"
                stroke="#673AB7"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M11.993 19.164C12.5623 19.164 13.605 18.8973 14.2877 18.1973C14.5115 17.9741 14.6884 17.7083 14.8079 17.4157C14.9274 17.123 14.9872 16.8094 14.9837 16.4933C14.9837 14.8613 13.5703 14 11.9903 14C10.653 14 9.89567 14.7253 9.625 15.1827"
                stroke="#673AB7"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M9.3125 23.3865C9.61917 23.9038 10.5445 25.0025 12.0552 25.0025C13.8418 25.0025 15.3125 24.0065 15.3125 22.2638C15.3125 21.4745 15.0845 20.7638 14.5898 20.2585C13.8165 19.4692 12.6365 19.1665 11.9925 19.1665"
                stroke="#673AB7"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div id="video" class="tab">
            ...
            >
              <path
                d="M29.332 16.8V27.2C29.332 27.3051 29.3113 27.4091 29.2711 27.5061C29.2309 27.6032 29.172 27.6914 29.0977 27.7657C29.0234 27.84 28.9352 27.8989 28.8382 27.9391C28.7411 27.9793 28.6371 28 28.532 28H18.132C17.9199 28 17.7164 27.9157 17.5663 27.7657C17.4163 27.6157 17.332 27.4122 17.332 27.2V16.8C17.332 16.5878 17.4163 16.3843 17.5663 16.2343C17.7164 16.0843 17.9199 16 18.132 16H28.532C28.6371 16 28.7411 16.0207 28.8382 16.0609C28.9352 16.1011 29.0234 16.16 29.0977 16.2343C29.172 16.3086 29.2309 16.3968 29.2711 16.4939C29.3113 16.5909 29.332 16.6949 29.332 16.8Z"
                stroke="#1D272C"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              ></path>
              <path
                d="M22.556 19.4347C22.4348 19.359 22.2955 19.3171 22.1526 19.3134C22.0097 19.3097 21.8685 19.3444 21.7435 19.4138C21.6186 19.4832 21.5145 19.5848 21.4421 19.7081C21.3698 19.8314 21.3317 19.9718 21.332 20.1147V23.8934C21.3317 24.0363 21.3698 24.1767 21.4421 24.3C21.5145 24.4233 21.6186 24.5249 21.7435 24.5943C21.8685 24.6637 22.0097 24.6984 22.1526 24.6947C22.2955 24.691 22.4348 24.6491 22.556 24.5734L25.58 22.6827C25.6952 22.6108 25.7902 22.5108 25.8561 22.3921C25.9219 22.2734 25.9565 22.1398 25.9565 22.004C25.9565 21.8683 25.9219 21.7347 25.8561 21.616C25.7902 21.4973 25.6952 21.3973 25.58 21.3254L22.556 19.4347Z"
                stroke="#1D272C"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div id="scheduling" class="tab">
            ...
            >
              ...
              />
              <path
                d="M12.0023 19.2665C12.0008 19.3407 12 19.415 12 19.4895C12 19.7738 12.0113 20.0555 12.0335 20.3342L2.5 24.2343V4.74477L16.8716 10.624C16.5388 10.8357 16.2188 11.0656 15.9129 11.3123L4.18932 6.51629L3.5 6.2343V6.97906V22V22.7448L4.18932 22.4628L12.0023 19.2665Z"
                stroke="#673AB7"
                stroke-linecap="round"
              />
              <path
                d="M22.5 15.4893V19.4893L25.5 21.4893"
                stroke="#673AB7"
                stroke-width="2"
                stroke-linecap="round"
              />
          ...
          <div id="permissions" class="tab">
            ...
            >
              ...
              ></path>
              <path
                d="M14.4648 16.2L25.3315 5.33337"
                stroke="#1D272C"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        document.querySelectorAll(tabSelector).forEach((el) => {
          el.addEventListener("click", (e) => {
            const thisEl = e.target,
              ...
              tabUnderline =
                thisEl.parentElement.querySelector(tabUnderlineSelector),
    ...
    <section
      id="tabsContent1"
      class="section-tabs-content breakout redsn-mb-400 clr-bg-500"
    >
      <div
        id="integrations_content"
        class="tab_content tab_section redsn-mt-400 active"
      >
        <div class="section__row redsn-pt-0">
          ...
          <div class="section__row__column content">
            ...
            <p>
              Integrate with different apps so you can collaborate from one
              place.
            </p>
      ...
      <div id="external_content" class="tab_content tab_section redsn-mt-400">
        <div class="section__row redsn-pt-0">
          ...
          <div class="section__row__column content">
            ...
            <p>
              Simplify the way you collaborate with external guests and invite
              them to a Pumble meeting even if they don’t have a Pumble account.
            </p>
      ...
      <div id="calendar_content" class="tab_content tab_section redsn-mt-400">
        <div class="section__row redsn-pt-0">
          ...
          <div class="section__row__column content">
            <h3>Google Calendar add-on</h3>

            <p>
              Schedule a Pumble meeting through Google Calendar with teammates
              and send a calendar invite to the meeting attendees.
            </p>

            <div class="buttons">
              <a
                href="https://workspace.google.com/marketplace/app/pumble_for_google_workspace/410021604819"
                class="redsn-button transparent"
                target="_blank"
              >
                <span>Learn more</span>
      ...
      <div id="scheduling_content" class="tab_content tab_section redsn-mt-400">
        <div class="section__row redsn-pt-0">
          ...
          <div class="section__row__column content">
            ...
            <p>
              Schedule your message to be sent when you want it, and don’t risk
              forgetting about it, without bothering anyone outside their work
              hours.
            </p>
      ...
      <div id="voice_content" class="tab_content tab_section redsn-mt-400">
        <div class="section__row redsn-pt-0">
          ...
          <div class="section__row__column content">
            ...
            <p>
              Sending voice notes in Pumble instead of text and increase your
              efficiency. Share ideas and updates, or just say hello to your
              teammates.
            </p>
      ...
      <div id="video_content" class="tab_content tab_section redsn-mt-400">
        <div class="section__row redsn-pt-0">
          ...
          <div class="section__row__column content">
            ...
            <p>
              Instead of scheduling a meeting, record a video message covering
      ...
      <div
        ...
        class="tab_content tab_section redsn-mt-400"
      >
        <div class="section__row redsn-pt-0">
          <div class="section__row__column image">
            <img
          ...
          <div class="section__row__column content">
            ...
            <p>
              Set up different workspaces and channel permissions within your
              workspace.
            </p>
    ...
    <section class="full-screen redsn-my-0 card">
      <!-- TODO: remove card class, left it for 'a' tag hover transition -->
      <h2 class="section-title redsn-mb-200">
        Trusted by companies around the world
      </h2>

      <a
        href="blog/category/customer-stories/index.html"
        class="redsn-button outline"
        target="@@target"
      >
        ...
        <div class="swiper-wrapper">
          <div class="testimonial-card card swiper-slide @@class">
            <div class="content">
              ...
              <h5>“Easy to keep in touch with co workers”</h5>
              <p>
                I have had a good experience. I love the faces that you can
                choose to have or you can have your own picture. Easy to keep in
                touch with co workers or your supervisor.
              </p>
            </div>
            ...
            <div class="author">
              <p>Cherie M.</p>
              <span
                >Customer service I Telecommunications,<br />201-500
                employees</span
              >
            </div>
          </div>
          <div class="testimonial-card card swiper-slide">
            <div class="content">
              <div class="star-rating">★★★★★</div>
              <h5>“Got me hooked right away”</h5>
              <p>
                To upgrade and get the max features for only $20 a year is
                amazing. I highly recommend this app. Once I tried, I was
                instantly annoyed that it wasn't the first one that I had tried
                in the first place.
              </p>
            </div>
            ...
            <div class="author">
              <p>Kimberly L.</p>
              <span
                >Human Resources I Hospital & Health Care,<br />201-500
                employees</span
              >
            </div>
          </div>
          <div class="testimonial-card card swiper-slide @@class">
            <div class="content">
              <div class="star-rating">★★★★★</div>
              <h5>“It doesn’t have limit on messages”</h5>
              <p>
                It doesn't have a limit on message and files history compared to
                Slack. This is what matter's most to me as I really would love
                to review messages from time to time.
              </p>
            </div>
            ...
            <div class="author">
              <p>Julie Anne B.</p>
              <span
                >SRS I | Government Administration,<br />51-200 employees</span
              >
            </div>
          </div>
          <div class="testimonial-card card swiper-slide @@class">
            <div class="content">
              <div class="star-rating">★★★★★</div>
              <h5>“Great experience overall”</h5>
              <p>
                I like the fact that I can create a thread in a specific message
                so that thing doesn’t get mixed up, makes for a very clear
                communication tool.
              </p>
            </div>
            ...
            <div class="author">
              <p>Ernesto S.</p>
              <span
                >Co-Founder I Information Technology and Services,<br />1-10
                employees</span
              >
            </div>
          </div>
          <div class="testimonial-card card swiper-slide">
            <div class="content">
              <div class="star-rating">★★★★★</div>
              <h5>“It’s changed the way I do business”</h5>
              <p>
                For anyone who’s working with a number of clients in any
                industry. It’s been an absolute game changer for me being able
                to add all of my clients in and chat to them 1-2-1 at all times.
              </p>
            </div>
            ...
            <div class="author">
              <p>Jess B.</p>
              <span
                >Nutritional coach I Health, Wellness and Fitness,<br />1-10
                employees</span
              >
            </div>
          </div>
          <div class="testimonial-card card swiper-slide @@class">
            <div class="content">
              <div class="star-rating">★★★★★</div>
              <h5>“Simplicity & easiness you feel”</h5>
              <p>
                Team communication got easier, we can see whether the person is
                active or not. It can be installed on phone. We can save notes
                by sending the documents to ourselves.
              </p>
            </div>
            ...
            <div class="author">
              <p>Krishna S.</p>
              <span
                >Associate I Information Technology and Services,<br />11-50
                employees</span
              >
            </div>
          </div>
    ...
    <section
      class="section-free card breakout clr-bg-500 text-center redsn-my-400"
    >
      <div class="content">
        <h2 class="section-title redsn-mt-0">Free Forever</h2>
        ...
        <div class="icon-list">
          <div class="icon-list__item">
            ...
            >
              <path
                id="Vector"
                d="M21.2246 11.25L13.7246 18.75"
                stroke="#673AB7"
                stroke-width="1.4"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <a href="pricing.html" class="redsn-button transparent" target="_blank">
    ...
    <section class="full-screen redsn-my-400 redsn-pb-400 clr-bg-500">
      <h2 class="section-title redsn-mb-75">World-class customer support</h2>
      ...
      <div class="special-span">
        ...
        <span class="special-text">Phone</span>
