...
<head>
  ...
  <title>Pumble™ - Register</title>
  <!-- for Google -->
  <meta
    name="description"
    content="Register for Pumble - Free Chat &amp; Collaboration App for Teams" />
  <meta
    name="image"
    content="https://pumble.com/assets/images/pumble-og.png" />
  <meta name="application-name" content="Pumble" />
  <!-- Schema.org for Google -->
  <meta itemprop="name" content="Pumble™ - Register" />
  <meta
  ...
  <meta
    ...
    content="https://pumble.com/assets/images/pumble-og.png" />
  <!-- for Facebook -->
  <meta property="og:title" content="Pumble™ - Register" />
  <meta
  ...
  <script
    ...
    async=""
    data-ueto="ueto_88b48ce211"></script>
</head>
...
<body id="home">
  ...
  <div style="display: flex" id="form" class="form-container">
    <div class="form-card-container form-card-container--standalone">
      <div class="form-card">
        ...
        <div class="form-content">
          <div class="form-content__title">Get started with Pumble</div>
        </div>

        <div style="display: flex" class="auth-container" id="auth-container">
          <button class="auth-button w-100">
            <img src="./assets/login-with-google.png" class="auth-img" /><span
              class="auth-text">Continue with Google</span></button><button class="auth-button w-100">
        ...
        <div class="form-input-container">
          ...
          <button id="send-lead-button" class="btn-primary w-100">
            Continue with email
          </button>
        </div>

        <span class="form-content__endnote">
          Already have an account?
          <a tabindex="0" id="login-link-button" class="link-inline">Log in</a>
        </span>
  ...
  <script>
    ...
    async function sendRegistrationRequest(email) {
      setFormLoading(true);
      ...
      try {
        ...
        window.location = `${config.pumbleWebsiteDomain}/verification?mode=register`;
    ...
    // Main registration form validation function
    ...
    document.addEventListener('DOMContentLoaded', () => {
      const emailInput = document.getElementById("email-input");
      const submitButton = document.getElementById("send-lead-button");
      ...
      if (submitButton) {
        submitButton.addEventListener("click", validateAndSubmitRegistration);
      }
