...
(function (_) {
  ...
  try {
    ...
    (0, _._F_toggles_initialize)([0x1cc88000, 0x18d9]);
    var aa, ba, ca, da, t, ea, ha, ma, na;
    aa = function (a) {
      var b = 0;
      return function () {
    ...
    t("Promise", function (a) {
      ...
      e.prototype.H = function (g) {
        ...
        typeof h == "function" ? this.S(h, g) : this.o(g);
      };
...
*/
    ...
    _.wa = function (a) {
      if (!_.ua || !_.va) return !1;
      for (var b = 0; b < _.va.brands.length; b++) {
        var c = _.va.brands[b].brand;
    ...
    _.za = function () {
      return _.ya() ? !1 : _.w("Opera");
    };
    _.Aa = function () {
      return _.ya() ? !1 : _.w("Trident") || _.w("MSIE");
    };
    _.Ba = function () {
      return _.ya() ? !1 : _.w("Edge");
    };
    _.Ca = function () {
      return _.ya() ? _.wa("Microsoft Edge") : _.w("Edg/");
    };
    _.Da = function () {
    ...
    _.Ea = function () {
      return _.ya()
        ? _.wa("Chromium")
        : ((_.w("Chrome") || _.w("CriOS")) && !_.Ba()) || _.w("Silk");
    };
    _.Ga = function (a) {
      var b = {};
    ...
    _.Ja = function () {
      return Ia() || _.w("iPad") || _.w("iPod");
    };
    _.Ka = function () {
      return _.Ha() ? _.va.platform === "macOS" : _.w("Macintosh");
    };
    _.Ma = function (a, b) {
      b = (0, _.La)(a, b);
      var c;
    ...
    _.Qa = function (a, b) {
      if (a != null) {
        var c;
        var d = (c = Pa) != null ? c : (Pa = {});
        c = d[a] || 0;
        c >= b || ((d[a] = c + 1), (a = Error()), _.Oa(a, "incident"), _.sa(a));
      }
    };
    _.Ra = function (a, b, c) {
    ...
    _.kb = function (a) {
      ...
      return ib
        ? BigInt(a)
        : (a = jb(a) ? (a ? "1" : "0") : gb(a) ? a.trim() || "0" : String(a));
    };
    lb = function (a, b) {
    ...
    _.qb = function (a, b, c) {
      if (a != null && typeof a === "object" && cb(a)) return a;
      if (Array.isArray(a)) {
        var d = a[_.x] | 0,
          e = d;
        e === 0 && (e |= c & 32);
    ...
    _.xb = function (a, b, c, d, e) {
      ...
      if (b & 64) {
        if (b & 256) {
          ...
          var k = a[g];
          var m = g;
        } else (m = 4294967295), (k = void 0);
        if (!(e || b & 512)) {
          h = !0;
          var n;
          var p = ((n = vb) != null ? n : rb)(
            k ? m - -1 : (b >> 15) & 1023 || 536870912,
            -1,
            a,
            k
          );
        ...
        for (var A in k)
          (g = k[A]),
            g != null &&
              ...
              q < p
                ? (d[q + -1] = g)
                : ((q = void 0), (((q = n) != null ? q : (n = {}))[A] = g)));
      n && (h ? d.push(n) : (d[m] = n));
      e &&
        (_.Wa(d, (b & 33522241) | (n != null ? 290 : 34)),
        _.sb(_.tb) &&
          (a = _.ub(a)) &&
          "function" == typeof _.wb &&
          a instanceof _.wb &&
          (d[_.tb] = a.i()));
      return d;
    };
    zb = function (a) {
      switch (typeof a) {
        ...
        case "bigint":
          return (0, _.yb)(a) ? Number(a) : "" + a;
        case "boolean":
          return a ? 1 : 0;
        case "object":
          if (Array.isArray(a)) {
            var b = a[_.x] | 0;
            return a.length === 0 && b & 1 ? void 0 : _.xb(a, b, zb, !1, !1);
          }
          if (cb(a)) return _.Ab(a);
          if ("function" == typeof _.Bb && a instanceof _.Bb) return a.i();
          return;
      }
      return a;
    };
    _.Ab = function (a) {
      a = a.v;
      return _.xb(a, a[_.x] | 0, zb, void 0, !1);
    };
    Eb = function (a) {
      switch (typeof a) {
        case "boolean":
          return Cb || (Cb = [0, void 0, !0]);
        case "number":
          return a > 0
            ? void 0
            : a === 0
    ...
    Fb = function (a, b, c, d) {
      if (a == null) {
        ...
        if (!Array.isArray(a)) throw Error("z");
        e = a[_.x] | 0;
        8192 & e || !(64 & e) || 2 & e || Hb();
        if (e & 1024) throw Error("B");
        if (e & 64) return d !== 3 || e & 16384 || _.Wa(a, e | 16384), a;
        d === 1 || d === 2 || (e |= 64);
        if (c && ((e |= 512), c !== a[0])) throw Error("C");
        a: {
          c = a;
          var f = c.length;
          if (f) {
          ...
          if (b) {
            ...
            if (k > 1024) throw Error("F");
            e = (e & -33521665) | ((k & 1023) << 15);
          }
        }
      }
      d === 3 && (e |= 16384);
    ...
    _.Jb = function (a, b) {
      ...
      if (Array.isArray(a)) {
        ...
        return d
          ? (_.Va(a, 34), c & 4 && Object.freeze(a), a)
          : _.xb(a, c, _.Jb, b !== void 0, !0);
      }
      if (cb(a))
        return (
          (b = a.v), (c = b[_.x] | 0), c & 2 ? a : _.xb(b, c, _.Jb, !0, !0)
        );
      if ("function" == typeof _.Bb && a instanceof _.Bb) return a;
    };
    _.Kb = function (a) {
      var b = a.v;
      if (!((b[_.x] | 0) & 2)) return a;
      a = new a.constructor(_.xb(b, b[_.x] | 0, _.Jb, !0, !0));
      b = a.v;
      b[_.x] &= -3;
      return a;
    };
    _.Lb = function (a, b, c, d, e) {
      var f = c + (e ? 0 : -1),
        g = a.length - 1,
        h;
      if (f >= g && ((h = b) != null ? h : (b = a[_.x] | 0)) & 256)
        return (a[g][c] = d), b;
    ...
    Sb = function (a) {
      var b = Pb;
      var c = c === void 0 ? _.Qb : c;
      return new _.Rb(a, b, c);
    };
    ...
    _.Tb = function (a, b) {
      if (a instanceof _.B) return a.v;
      if (Array.isArray(a)) return _.Gb(a, b, !1);
    };
    _.$b = function (a, b, c) {
      return new _.Rb(a, b, c);
    };
    _.bc = function (a, b, c) {
      _.Lb(a, a[_.x] | 0, b, c, (a[_.x] | 0) & 512 ? _.ac : void 0);
    };
    ec = function (a) {
      a = cc.get(a);
      var b = cc.get(_.dc);
    ...
    _.F = function (a, b) {
      try {
        ec("error") &&
          ...
          window.console.error(fc(b) + a);
      } catch (c) {}
    };
    _.hc = function (a) {
      _.gc.g.search_experiment = a;
      _.C("Experiment search_experiment set to " + a + ".");
    };
    ic = function (a, b, c) {
    ...
    _.mc = function (a) {
      if (a instanceof _.lc) return a.g;
      throw Error("Q");
    };
    oc = function (a) {
      return new _.nc(function (b) {
        return b.substr(0, a.length + 1).toLowerCase() === a + ":";
      });
    };
    _.qc = function (a) {
      a instanceof _.lc ? (a = _.mc(a)) : (a = pc.test(a) ? a : void 0);
      return a;
    };
    _.rc = function (a, b) {
      b = _.qc(b);
    ...
    _.vc = function (a, b) {
      ...
      var c = {
        ...
        enable_granular_consent:
          b.enable_granular_consent === void 0
    ...
    _.Cc = function (a, b, c) {
      _.Cc =
        ...
        Function.prototype.bind.toString().indexOf("native code") != -1
          ? Ac
          : Bc;
      return _.Cc.apply(null, arguments);
    };
    _.H = function (a, b) {
      a = a.split(".");
      for (var c = _.v, d; a.length && (d = a.shift()); )
        a.length || b === void 0
    ...
    _.uc = function (a, b) {
      ...
      Object.setPrototypeOf(this, _.uc.prototype);
      this.type = b || "unknown";
    };
    _.G(_.uc, Error);
    _.Ec = typeof TextDecoder !== "undefined";
    _.Gc = typeof String.prototype.isWellFormed === "function";
    _.Hc = typeof TextEncoder !== "undefined";
    ...
    var Jc = !!(_.ra[0] & 1024),
      Kc = !!(_.ra[0] & 2048),
      Lc = !!(_.ra[0] & 4096);
    _.ua = Jc ? Kc : zc(610401301);
    _.Mc = Jc ? Lc : zc(1981196515);
    var Nc;
    Nc = _.v.navigator;
    _.va = Nc ? Nc.userAgentData || null : null;
    ...
    _.Vc =
      _.w("Gecko") &&
      !(_.ta().toLowerCase().indexOf("webkit") != -1 && !_.w("Edge")) &&
      !(_.w("Trident") || _.w("MSIE")) &&
      !_.w("Edge");
    _.Wc = _.ta().toLowerCase().indexOf("webkit") != -1 && !_.w("Edge");
    a: {
      var Yc = "",
        Zc = (function () {
          var a = _.ta();
    ...
    var cd = _.Da(),
      dd = Ia() || _.w("iPod"),
      ed = _.w("iPad"),
      fd = _.w("Android") && !(_.Ea() || _.Da() || _.za() || _.w("Silk")),
      gd = _.Ea(),
      hd = _.Fa() && !_.Ja();
    _.id = typeof Uint8Array !== "undefined";
    _.jd = !_.Tc && typeof btoa === "function";
    var Pa = void 0;
    var kd, Ib, Xa, $a;
    _.Sa = typeof Symbol === "function" && typeof Symbol() === "symbol";
    kd = _.Ra("jas", void 0, !0);
    _.tb = _.Ra(void 0, Symbol());
    _.ld = _.Ra(void 0, "0ub");
    Ib = _.Ra(void 0, "0actk");
    Xa = _.Ra("m_m", "Be", !0);
    $a = _.Ra(void 0, "mrtk");
    var Ua, Ta, nd;
    Ua = { Jd: { value: 0, configurable: !0, writable: !0, enumerable: !1 } };
    Ta = Object.defineProperties;
    _.x = _.Sa ? kd : "Jd";
    nd = [];
    _.Wa(nd, 55);
    _.md = Object.freeze(nd);
    var Za, Ya;
    Za = typeof Xa === "symbol";
    Ya = {};
    _.od = Object.freeze({});
    ...
    var ib =
      typeof _.v.BigInt === "function" && typeof _.v.BigInt(0) === "bigint";
    var rd, pd, sd, qd;
    _.yb = fb(function (a) {
      return ib ? a >= pd && a <= qd : a[0] === "-" ? lb(a, rd) : lb(a, sd);
    });
    rd = Number.MIN_SAFE_INTEGER.toString();
    pd = ib ? BigInt(Number.MIN_SAFE_INTEGER) : void 0;
    sd = Number.MAX_SAFE_INTEGER.toString();
    qd = ib ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
    _.td = typeof Uint8Array.prototype.slice === "function";
    _.ud = typeof BigInt === "function" ? BigInt.asIntN : void 0;
    _.vd = Number.isSafeInteger;
    ...
    _.xd = _.kb(0);
    _.yd = function (a, b) {
      return _.Mb(a.v, void 0, b);
    };
    _.Mb = function (a, b, c, d) {
      if (c === -1) return null;
      d = c + (d ? 0 : -1);
      var e = a.length - 1;
      if (d >= e && (b != null ? b : a[_.x] | 0) & 256) a = a[e][c];
      else if (d <= e) a = a[d];
      else return;
      return a;
    };
    _.zd = function (a, b, c) {
      return Nb(a, b, c) !== void 0;
    };
    Ad = function (a, b, c) {
      var d = a[_.x] | 0,
        e = d & 512 ? _.ac : void 0,
        f = _.Mb(a, d, c, e);
      if (f != null && cb(f))
        return (b = _.Kb(f)), b !== f && _.Lb(a, d, c, b, e), b.v;
      if (Array.isArray(f)) {
        var g = f[_.x] | 0;
        if (g & 2) {
          var h = _.Gb(_.xb(f, g, _.Jb, !0, !0), b, !0);
          h[_.x] &= -3;
        } else g & 64 ? (h = f) : (h = _.Gb(h, b, !0));
      } else h = _.Gb(void 0, b, !0);
      h !== f && _.Lb(a, d, c, h, e);
      return h;
    };
    _.I = function (a, b, c, d) {
      ...
      if (!(e & 2)) {
        var f = _.Kb(b);
        f !== b && ((b = f), _.Lb(a, e, c, b, d));
      }
      return b;
    };
    _.J = function (a, b) {
      return _.pb(_.yd(a, b));
    };
    _.K = function (a, b) {
      a = _.yd(a, b);
    ...
    _.B.prototype.ya = function () {
      return !!((this.v[_.x] | 0) & 2);
    };
    _.B.prototype[Xa] = Ya;
    ...
    Wb = Sb(function (a, b, c, d, e) {
      if (a.h !== 2) return !1;
      a.l(Ad(b, d, c), e);
      return !0;
    });
    Yb = Sb(function (a, b, c, d, e) {
      if (a.h !== 2) return !1;
      a.l(Ad(b, d, c), e);
      return !0;
    });
    ...
    _.Id = new _.lc("about:invalid#zClosurez");
    var pc;
    _.nc = function (a) {
      this.Ld = a;
    };
    ...
    _.Pd = function (a) {
      ...
      a instanceof _.Pd
        ...
        ? ((this.l = !1),
          ...
          _.Sd(this, b[6] || "", !0),
          (this.o = Ud(b[7] || "")))
        : ((this.l = !1), (this.j = new _.Vd(null, this.l)));
    };
    _.Pd.prototype.toString = function () {
      ...
      if (c || b == "file")
        a.push("//"),
          (b = this.getUserInfo()) && a.push(Wd(b, Xd, !0), "@"),
          a.push(
      ...
      if ((c = this.i))
        this.g && c.charAt(0) != "/" && a.push("/"),
          a.push(Wd(c, c.charAt(0) == "/" ? Yd : Zd, !0));
      (c = this.j.toString()) && a.push("?", c);
      (c = this.o) && a.push("#", Wd(c, $d));
      return a.join("");
    };
    _.Pd.prototype.resolve = function (a) {
      var b = new _.Pd(this),
        c = !!a.h;
      c ? _.Qd(b, a.h) : (c = !!a.u);
      if (c) {
    ...
    _.Pd.prototype.getUserInfo = function () {
      return this.u;
    };
    _.Rd = function (a, b) {
      if (b) {
    ...
    _.Sd = function (a, b, c) {
      b instanceof _.Vd
        ? ((a.j = b), ae(a.j, a.l))
        : (c || (b = Wd(b, be)), (a.j = new _.Vd(b, a.l)));
    };
    _.ce = function (a) {
      return a instanceof _.Pd ? new _.Pd(a) : new _.Pd(a);
    };
    Ud = function (a, b) {
      return a
        ? b
    ...
    _.Vd.prototype.add = function (a, b) {
      ee(this);
      this.i = null;
      a = fe(this, a);
      var c = this.g.get(a);
    ...
    _.Vd.prototype.clear = function () {
      this.g = this.i = null;
      this.h = 0;
    };
    _.Vd.prototype.pb = function () {
      ee(this);
      return this.h == 0;
    };
    var ge = function (a, b) {
    ...
    _.l.ka = function (a) {
      ...
      var b = [];
      if (typeof a === "string")
        ge(this, a) && (b = b.concat(this.g.get(fe(this, a))));
      else {
    ...
    _.l.set = function (a, b) {
      ...
      this.i = null;
      a = fe(this, a);
      ge(this, a) && (this.h -= this.g.get(a).length);
      this.g.set(a, [b]);
      this.h += 1;
      return this;
    };
    ...
    _.he = function (a, b, c) {
      a.remove(b);
      c.length > 0 &&
        ((a.i = null), a.g.set(fe(a, b), _.Na(c)), (a.h += c.length));
    };
      ...
      ae = function (a, b) {
        b &&
          ...
          a.g.forEach(function (c, d) {
            var e = d.toLowerCase();
            d != e && (this.remove(d), _.he(this, e, c));
          }, a));
        a.j = b;
      };
    for (var ie = [], je = 0; je < 63; je++) ie[je] = 0;
    _.ke = [].concat(128, ie);
    var me;
    _.le = function (a) {
      this.g = a || { cookie: "" };
    ...
    _.l.clear = function () {
      for (var a = me(this).keys, b = a.length - 1; b >= 0; b--)
        this.remove(a[b]);
    };
    me = function (a) {
      a = (a.g.cookie || "").split(";");
    ...
    _.ne = new _.le(typeof document == "undefined" ? null : document);
    _.oe =
    ...
    _.pe.prototype.s = !1;
    _.pe.prototype.Rc = function () {
      return this.s;
    };
    _.pe.prototype.dispose = function () {
      this.s || ((this.s = !0), this.fa());
    };
    _.pe.prototype[Symbol.dispose] = function () {
      this.dispose();
    };
    _.pe.prototype.fa = function () {
    ...
    se.prototype.init = function (a, b) {
      ...
      d
        ...
        : ((this.j = _.Wc || a.offsetX !== void 0 ? a.offsetX : a.layerX),
          (this.l = _.Wc || a.offsetY !== void 0 ? a.offsetY : a.layerY),
      ...
      this.state = a.state;
      this.g = a;
      a.defaultPrevented && se.ua.preventDefault.call(this);
    };
    se.prototype.stopPropagation = function () {
      se.ua.stopPropagation.call(this);
      this.g.stopPropagation
        ? this.g.stopPropagation()
        : (this.g.cancelBubble = !0);
    };
    se.prototype.preventDefault = function () {
      se.ua.preventDefault.call(this);
      var a = this.g;
    ...
    var te;
    te = "closure_listenable_" + ((Math.random() * 1e6) | 0);
    _.ue = function (a) {
      return !(!a || !a[te]);
    };
    var ve = 0;
    ...
    sc.prototype.add = function (a, b, c, d, e) {
      ...
      g > -1
        ? ((b = a[g]), c || (b.kb = !1))
        : ((b = new we(b, this.src, f, !!d, e)), (b.kb = c), a.push(b));
      return b;
    };
    ...
    ze = function (a, b) {
      ...
      var d = _.Ma(a.g[c], b);
      d && (xe(b), a.g[c].length == 0 && (delete a.g[c], a.h--));
      return d;
    };
    _.Ae = function (a, b) {
      b = b && b.toString();
      ...
      for (d in a.g)
        if (!b || d == b) {
          for (var e = a.g[d], f = 0; f < e.length; f++) ++c, xe(e[f]);
          delete a.g[d];
          a.h--;
        }
    };
    sc.prototype.Ua = function (a, b, c, d) {
      a = this.g[a.toString()];
      var e = -1;
      a && (e = ye(a, b, c, d));
      return e > -1 ? a[e] : null;
    ...
    var ye = function (a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];
        if (!f.Xa && f.listener == b && f.capture == !!c && f.va == d) return e;
      }
      return -1;
    };
    var Be, Ce, De, Ge, Ie, Le, Je, Ke, Ne, Fe;
    Be = "closure_lm_" + ((Math.random() * 1e6) | 0);
    Ce = {};
    De = 0;
    _.O = function (a, b, c, d, e) {
      if (d && d.once) return _.Ee(a, b, c, d, e);
      if (Array.isArray(b)) {
      ...
      c = Fe(c);
      return _.ue(a)
        ? a.K(b, c, _.yc(d) ? !!d.capture : !!d, e)
        : Ge(a, b, c, !1, d, e);
    };
    Ge = function (a, b, c, d, e, f) {
      if (!b) throw Error("$");
      var g = _.yc(e) ? !!e.capture : !!e,
        h = _.He(a);
      h || (a[Be] = h = new sc(a));
      c = h.add(b, c, d, g, f);
      if (c.proxy) return c;
    ...
    _.Ee = function (a, b, c, d, e) {
      if (Array.isArray(b)) {
        for (var f = 0; f < b.length; f++) _.Ee(a, b[f], c, d, e);
        return null;
      }
      c = Fe(c);
      return _.ue(a)
        ? a.Qb(b, c, _.yc(d) ? !!d.capture : !!d, e)
        : Ge(a, b, c, !0, d, e);
    };
    Le = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.yc(d) ? !!d.capture : !!d),
          ...
          _.ue(a)
            ? a.Da(b, c, d, e)
            : a && (a = _.He(a)) && (b = a.Ua(b, c, d, e)) && _.Me(b);
    };
    _.Me = function (a) {
      if (typeof a === "number" || !a || a.Xa) return !1;
      var b = a.src;
      if (_.ue(b)) return ze(b.ga, a);
      var c = a.type,
        d = a.proxy;
      b.removeEventListener
        ? b.removeEventListener(c, d, a.capture)
        : b.detachEvent
        ? b.detachEvent(Je(c), d)
        : b.addListener && b.removeListener && b.removeListener(d);
      De--;
      (c = _.He(b))
        ? (ze(c, a), c.h == 0 && ((c.src = null), (b[Be] = null)))
        : xe(a);
      return !0;
    };
    Je = function (a) {
    ...
    Ne = "__closure_events_fn_" + ((Math.random() * 1e9) >>> 0);
    Fe = function (a) {
    ...
    _.l.dispatchEvent = function (a) {
      ...
      c = this.B;
      var d = a.type || a;
      if (typeof a === "string") a = new qe(a, c);
      ...
      if (b)
        for (f = 0; !a.i && f < b.length; f++)
          (g = a.h = b[f]), (e = Pe(g, d, !1, a) && e);
      return e;
    };
    _.l.fa = function () {
      _.Oe.ua.fa.call(this);
      this.ga && _.Ae(this.ga);
      this.l = null;
    };
    ...
    _.Oe.prototype.Ua = function (a, b, c, d) {
    ...
    _.Re = (function () {
      if (cd) return Qe(/Firefox\/([0-9.]+)/);
      if (_.Tc || Uc || Sc) return bd;
      if (gd) {
        if (_.Ja() || _.Ka()) {
          var a = Qe(/CriOS\/([0-9.]+)/);
          if (a) return a;
        }
        return Qe(/Chrome\/([0-9.]+)/);
      }
      if (hd && !_.Ja()) return Qe(/Version\/([0-9.]+)/);
      if (dd || ed) {
        if ((a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.ta())))
          return a[1] + "." + a[2];
      } else if (fd)
        return (a = Qe(/Android\s+([0-9.]+)/)) ? a : Qe(/Version\/([0-9.]+)/);
      return "";
    })();
    _.Se = window;
    _.Te = function (a) {
    ...
    _.Dc(_.Te, _.pe);
    var Ue = [];
    _.Te.prototype.K = function (a, b, c, d) {
      Array.isArray(b) || (b && (Ue[0] = b.toString()), (b = Ue));
      for (var e = 0; e < b.length; e++) {
        var f = _.O(a, b[e], c || this.handleEvent, d || !1, this.h || this);
        if (!f) break;
        this.g[f.key] = f;
      }
      return this;
    };
    _.Te.prototype.Qb = function (a, b, c, d) {
    ...
    var Ve = function (a, b, c, d, e, f) {
      if (Array.isArray(c))
        ...
        b = _.Ee(b, c, d || a.handleEvent, e, f || a.h || a);
        if (!b) return a;
        a.g[b.key] = b;
      }
      return a;
    };
    _.Te.prototype.Da = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (c = c || this.handleEvent),
          ...
          (b = _.ue(a)
            ...
            ? (a = _.He(a))
              ...
              : null
            : null),
          b && (_.Me(b), delete this.g[b.key]);
    };
    var We = function (a) {
      ic(
        a.g,
        function (b, c) {
          this.g.hasOwnProperty(c) && _.Me(b);
        },
        a
      );
      a.g = {};
    };
    _.Te.prototype.fa = function () {
      _.Te.ua.fa.call(this);
      We(this);
    };
    _.Te.prototype.handleEvent = function () {
      throw Error("da");
    };
    _.Xe = function (a, b) {
      _.Oe.call(this);
      this.j = a || 1;
      this.i = b || _.v;
      this.u = (0, _.Cc)(this.H, this);
      this.A = Date.now();
    };
    _.Dc(_.Xe, _.Oe);
    _.Xe.prototype.h = !1;
    _.Xe.prototype.g = null;
    _.Xe.prototype.H = function () {
      if (this.h) {
        ...
        a > 0 && a < this.j * 0.8
          ...
          : (this.g && (this.i.clearTimeout(this.g), (this.g = null)),
            ...
            this.h && (_.Ye(this), this.start()));
      }
    };
    _.Xe.prototype.start = function () {
      this.h = !0;
      this.g ||
    ...
    _.Xe.prototype.fa = function () {
      _.Xe.ua.fa.call(this);
      _.Ye(this);
      delete this.i;
    };
    _.Ze = function (a, b) {
    ...
    _.Ze.prototype.i = function () {
      this.h &&
        (_.Ye(this.h),
        _.C("Popup timer stopped.", "OAUTH2_CLIENT"),
        (this.h = void 0),
        (this.A = !0));
    };
    _.$e = function (a) {
      a.u ||
        ...
        window.addEventListener(
          ...
          function (b) {
            try {
              if (b.data)
                if (b.origin !== _.Nd(a.l))
                  _.D("Message ignored. Different origin.", "OAUTH2_CLIENT");
                else {
              ...
              else _.D("Message ignored. No event data.", "OAUTH2_CLIENT");
            } catch (d) {
              _.D(
    ...
    _.bf = function (a) {
      a.error_callback &&
        a.g &&
        !a.h &&
        (_.D("Starting popup timer.", "OAUTH2_CLIENT"),
        (a.A = !1),
        (a.h = new _.Xe(500)),
        new _.Te(a).K(a.h, "tick", a.B),
        a.h.start());
    };
    _.Ze.prototype.B = function () {
      _.C("Checking popup closed.", "OAUTH2_CLIENT");
      !this.h ||
        this.A ||
        (this.g && !this.g.closed) ||
        (_.D("Popup window closed.", "OAUTH2_CLIENT"),
        this.error_callback &&
          this.error_callback(new _.uc("Popup window closed", "popup_closed")),
        _.Ye(this.h),
        (this.g = this.h = void 0));
    };
    _.M("cancelable_auto_select");
    _.M("enable_fedcm_beta_launch");
    _.M("enable_fedcm_auto_reauthn");
    _.M("enable_fedcm_button");
    _.M("enable_fedcm_cross_origin_iframe");
    _.M("enable_fedcm_csp");
    _.M("enable_fedcm_csp_and_iframe_logs");
    _.M("enable_fedcm_domain_hint");
    _.M("enable_fedcm_revocation_client");
    _.M("enable_forced_fedcm_cross_origin_iframe");
    _.M("enable_gis_oauth_button_flow_popup");
    _.M("enable_gis_oauth_button_flow_redirect");
    _.M("enable_intermediate_iframe");
    _.M("enable_manual_fedcm_launch");
  } catch (e) {
    _._DumpException(e);
  }
  try {
    var ag, hg, jg, kg, mg, ng, rg, ug, wg, Dg, xg, Hg, Kg, og, ig, lg;
    _.Zf = function (a) {
      a = Error(a);
      _.Oa(a, "warning");
      return a;
    ...
    ag = function () {
      var a = _.xa(_.ta());
      a = _.Ga(a);
      return _.Ea() ? a(["Chrome", "CriOS", "HeadlessChrome"]) : "";
    };
    _.bg = function () {
      if (_.ya()) {
    ...
    jg = function (a, b, c, d) {
      var e,
        ...
        g = c.h;
      a[b] = function (h, k, m) {
        return g(h, k, m, f || (f = _.Xb(ig, hg, jg, d).Na), e || (e = kg(d)));
      };
    };
    kg = function (a) {
      var b = a[lg];
      if (!b) {
        var c = _.Xb(ig, hg, jg, a);
        b = function (d, e) {
          return mg(d, e, c);
        };
        a[lg] = b;
    ...
    mg = function (a, b, c) {
      _.eb(a, a[_.x] | 0 | (c.Na[1] ? 512 : 0), function (d, e) {
        if (e != null) {
          var f = ng(c, d);
          f && f(b, e, d);
        }
      ...
      (a = _.ub(a)) &&
        a.g(function (d, e, f) {
          og(b, b.g.end());
          for (d = 0; d < f.length; d++) og(b, f[d].h() || new Uint8Array(0));
        });
    };
    ng = function (a, b) {
      var c = a[b];
    ...
    _.pg = function (a) {
      return function (b) {
        if (b == null || b == "") b = new a();
          ...
          b = JSON.parse(b);
          if (!Array.isArray(b)) throw Error("P");
          _.Va(b, 32);
          b = new a(b);
        }
        return b;
    ...
    ug = function (a, b) {
      ...
      sg === void 0 && (_.v.Int32Array ? (sg = new Int32Array(tg)) : (sg = tg));
      this.reset();
    };
    wg = function () {
      ug.call(this, 8, vg);
    ...
    _.Eg = function (a, b) {
      var c = c === void 0 ? 0 : c;
      var d;
      return (d = _.K(a, b)) != null ? d : c;
    };
    _.Fg = function (a, b) {
      var c;
      return (c = _.K(a, b)) != null ? c : void 0;
    };
    _.Gg = function (a, b, c) {
      if (c != null) {
        if (typeof c !== "number") throw _.Zf("int32");
        if (!(0, _.nb)(c)) throw _.Zf("int32");
        c |= 0;
      }
      return _.Cg(a, b, c);
    };
    ...
    Kg.prototype.o = function (a, b) {
      b != null &&
        ((b = parseInt(b, 10)), _.Ig(this.g, a * 8), _.Jg(this.g, b));
    };
      ...
      if (b != null) {
        ...
        if (_.Hc) {
          if (
            ...
            throw Error("r");
          b = (Dg || (Dg = new TextEncoder())).encode(b);
        } else {
          for (
    ...
    ig = Symbol();
    lg = Symbol();
    _.Lg = [0, _.Dd, -1, _.Ed, _.Dd, -2, _.Ed, _.Dd, 1, _.Dd, -2];
    _.Mg = function (a) {
      this.v = _.z(a);
    };
    _.G(_.Mg, _.B);
    _.Mg.prototype.g = (function (a) {
      return function () {
        var b = new Kg();
        mg(this.v, b, _.Xb(ig, hg, jg, a));
        og(b, b.g.end());
        for (
    ...
    ug.prototype.digest = function () {
      var a = [],
        b = this.j * 8;
      this.h < 56
        ? this.update(_.ke, 56 - this.h)
        : this.update(_.ke, this.blockSize - (this.h - 56));
    ...
    _.Pg.prototype.resolve = function (a) {
      if (!this.h) throw Error("fa");
      this.h(a);
      this.dispose();
    };
    _.Pg.prototype.reject = function (a) {
      if (!this.g) throw Error("fa");
      this.g(a);
      this.dispose();
    };
  ...
  try {
    var Si, aj, bj, cj, dj, ej, fj, gj, hj, ij, jj, kj, lj, vj, wj;
    Si = function (a) {
    ...
    _.Ti = function (a) {
      if (!a.startsWith(")]}'\n"))
        throw (console.error("malformed JSON response:", a), Error("ga"));
      a = a.substring(5);
      return JSON.parse(a);
    };
    _.Ui = function (a, b, c) {
      ...
      var d = !!(64 & b) || !(8192 & b),
        ...
        g = f !== _.md;
      if (d || !g) {
        g = d = f === _.md ? 55 : f[_.x] | 0;
        if (2 & g || _.fg(g) || (4 & g && !(32 & g)))
          (f = _.mb(f)), (d = 0), (g = _.dg(g, b)), (b = _.Lb(a, b, c, f, e));
        g = _.eg(g, b) & -13;
        g = _.gg(g, b, !0);
        g !== d && _.Wa(f, g);
      }
    ...
    _.Xi = function (a) {
      ...
      if (a)
        for (var c = _.u(Object.keys(a)), d = c.next(); !d.done; d = c.next())
          (d = d.value), a[d] !== void 0 && a[d] !== "" && (b[d] = a[d]);
      return b;
    };
    _.Zi = function (a, b) {
      a = new _.Pd(a);
      b && _.Sd(a, _.Yi(_.Xi(b)));
      return a.toString();
    };
    _.$i = function (a, b) {
      var c;
      return (c = _.J(a, b)) != null ? c : void 0;
    };
    aj = function (a) {
      if (a.ka && typeof a.ka == "function") return a.ka();
      if (
    ...
    fj = function (a) {
      a.Hb ||
        ((a.Hb = !0), a.dispatchEvent("complete"), a.dispatchEvent("error"));
    };
    gj = function (a, b) {
      if (a.D) {
    ...
    jj = function (a) {
      if (a.na && typeof _.qa != "undefined")
        if (a.ob && ij(a) == 4) setTimeout(a.Xc.bind(a), 0);
        else if ((a.dispatchEvent("readystatechange"), ij(a) == 4)) {
          a.na = !1;
          try {
            var b = a.Nc();
            a: switch (b) {
            ...
            if (!(d = c)) {
              var e;
              if ((e = b === 0)) {
                var f = String(a.Pb).match(_.Md)[1] || null;
                !f &&
                  _.v.self &&
                  _.v.self.location &&
                  (f = _.v.self.location.protocol.slice(0, -1));
                e = !cj.test(f ? f.toLowerCase() : "");
              }
              d = e;
            }
            d
    ...
    lj = function () {
      ...
      this.D = null;
      this.Pb = "";
      this.xa = this.Mb = this.ob = this.Hb = !1;
      this.ad = 0;
      this.Ca = null;
      this.Zc = "";
      this.be = this.bc = !1;
    ...
    _.l.send = function (a, b, c, d) {
      if (this.D) throw Error("ba`" + this.Pb + "`" + a);
      b = b ? b.toUpperCase() : "GET";
      this.Pb = a;
      this.Hb = !1;
      this.na = !0;
      this.D = new XMLHttpRequest();
      this.D.onreadystatechange = (0, _.oe)((0, _.Cc)(this.Xc, this));
      this.be &&
        "onprogress" in this.D &&
        ((this.D.onprogress = (0, _.oe)(
          (0, _.Cc)(function (g) {
            this.Wc(g, !0);
          }, this)
        )),
        this.D.upload &&
          (this.D.upload.onprogress = (0, _.oe)((0, _.Cc)(this.Wc, this))));
      try {
        (this.Mb = !0), this.D.open(b, String(a), !0), (this.Mb = !1);
      } catch (g) {
        hj(this);
        return;
      }
      ...
      "withCredentials" in this.D &&
        this.D.withCredentials !== this.bc &&
        (this.D.withCredentials = this.bc);
      if ("setTrustToken" in this.D && this.ac)
        try {
          this.D.setTrustToken(this.ac);
        } catch (g) {}
      if ("setAttributionReporting" in this.D && this.Bb)
        try {
          this.D.setAttributionReporting(this.Bb);
        } catch (g) {}
      try {
        this.Ca && (clearTimeout(this.Ca), (this.Ca = null)),
          this.ad > 0 && (this.Ca = setTimeout(this.ke.bind(this), this.ad)),
          (this.ob = !0),
          this.D.send(a),
          (this.ob = !1);
      } catch (g) {
    ...
    _.l.fa = function () {
      this.D &&
        (this.na &&
          ((this.na = !1), (this.xa = !0), this.D.abort(), (this.xa = !1)),
        gj(this, !0));
      lj.ua.fa.call(this);
    };
    _.l.Xc = function () {
      this.Rc() || (this.Mb || this.ob || this.xa ? jj(this) : this.ae());
    };
    _.l.ae = function () {
      jj(this);
    };
    _.l.Wc = function (a, b) {
      this.dispatchEvent(kj(a, "progress"));
      this.dispatchEvent(kj(a, b ? "downloadprogress" : "uploadprogress"));
    };
    ...
    _.l.Nc = function () {
      try {
        return ij(this) > 2 ? this.D.status : -1;
      } catch (a) {
        return -1;
      }
    };
    _.l.getResponseHeader = function (a) {
      if (this.D && ij(this) == 4)
        return (a = this.D.getResponseHeader(a)), a === null ? void 0 : a;
    };
    _.l.getAllResponseHeaders = function () {
      return this.D && ij(this) >= 2
        ? this.D.getAllResponseHeaders() || ""
        : "";
    };
    _.mj = function (a) {
      try {
    ...
    _.Yi = function (a) {
      ...
      for (var d = 0; d < b.length; d++) {
        var e = b[d],
          f = a[d];
        Array.isArray(f) ? _.he(c, e, f) : c.add(e, f);
      }
      return c;
    };
    _.rj = function (a, b, c, d, e, f) {
      var g = new lj();
      ej.push(g);
      b && g.K("complete", b);
      g.Qb("ready", g.yd);
    ...
    _.tj = function (a, b) {
      var c;
      return (c = _.ob(_.yd(a, b))) != null ? c : void 0;
    };
    _.uj = _.$b(
      function (a, b, c) {
        if (a.h !== 0) return !1;
      ...
      function (a, b, c) {
        b = Si(b);
        b != null && (_.Ig(a.g, c * 8), a.g.g.push(b ? 1 : 0));
      },
      _.Ob()
    );
    vj = new _.Rb(
      ...
      function (a, b, c) {
        ...
        if (b != null) for (d = 0; d < b.length; d++) a.l(c, b[d]);
      },
      _.Bd
    );
    wj = [0, _.Dd];
    ...
    _.zj = [0, _.Dd, -5, _.uj, wj, vj, _.Dd, _.uj, vj, _.uj, -1];
  } catch (e) {
    _._DumpException(e);
  }
  try {
...
*/
    ...
    _.Ej = function (a) {
      return "function" == typeof _.Dj && a instanceof _.Dj;
    };
    _.Fj = function (a) {
      if (_.Ej(a)) return a.g;
      throw Error("Q");
    };
    Hj = function (a) {
      var b = _.Cj();
      return new Gj(b ? b.createHTML(a) : a);
    };
    Ij = function (a) {
      if (a instanceof Gj) return a.g;
      throw Error("Q");
    };
    Jj = function (a) {
      return a instanceof Gj
        ? a
        : Hj(
            String(a)
              .replace(/&/g, "&amp;")
          ...
          case 0:
            ...
            if (m < 0) {
              ...
              c.push(a.substring(k, m)),
                ...
                (k = m + 1),
                Kj
                  ? ((Lj.lastIndex = k), (m = Lj.exec(a)))
                  : ((Lj.lastIndex = 0), (m = Lj.exec(a.substring(k)))),
                m
    ...
    _.Oj = function (a, b, c, d) {
      if ((b = b(c || Nj, d)) && b.h && a) b.h(a);
      else {
        a: if (_.yc(b)) {
          if (b.g && ((b = b.g()), b instanceof Gj)) break a;
          b = Jj("zSoyz");
        } else b = Jj(String(b));
        a.innerHTML = Ij(b);
      }
    ...
    _.Pj = function (a) {
      var b, c, d, e;
      return {
        id: (b = a.Kb()) != null ? b : null,
        givenName: (c = a.Fd()) != null ? c : null,
        displayName: (d = a.Ed()) != null ? d : null,
        profilePicture: (e = a.Gd()) != null ? e : null,
      };
    };
    _.U = function (a) {
      return !!_.gc.g[a];
    ...
    _.Rj = function (a, b) {
      ...
      c.getElementsByClassName
        ...
        : ((c = document),
          a
            ? (a = (b || c).querySelector(a ? "." + a : ""))
            : ((b = b || c),
              (a =
                (a
                  ? b.querySelectorAll(a ? "." + a : "")
                  : b.getElementsByTagName("*"))[0] || null)));
      return a || null;
    };
    _.Sj = function (a) {
    ...
    Xj.prototype.yc = null;
    Xj.prototype.toString = function () {
      return this.wb;
    };
    Xj.prototype.g = function () {
      if (this.zc !== _.Uj) throw Error("la");
      return Hj(this.toString());
    };
    var Yj = function () {
      Xj.call(this);
    };
    _.Dc(Yj, Xj);
    Yj.prototype.zc = _.Uj;
    var ek, Kj, Lj, lk, ck, mk, bk, nk, hk, dk;
    _.Zj = function (a) {
      if (a != null)
        switch (a.yc) {
          case 1:
    ...
    _.W = function (a) {
      return _.ak(a, _.Uj)
        ...
        : a instanceof Gj
        ? (0, _.V)(Ij(a).toString())
        : (0, _.V)(String(String(a)).replace(bk, ck), _.Zj(a));
    };
    _.V = (function (a) {
      function b(c) {
        this.wb = c;
    ...
    ek = function (a) {
      return Mj(String(a), function () {
        return "";
      }).replace(dk, "&lt;");
    };
    Kj = RegExp.prototype.hasOwnProperty("sticky");
    Lj = new RegExp(
      (Kj ? "" : "^") + "(?:!|/?([a-zA-Z][a-zA-Z0-9:-]*))",
      Kj ? "gy" : "g"
    );
    _.X = function (a) {
      return _.ak(a, _.Uj) ? _.fk(ek(a.wb)) : String(a).replace(bk, ck);
    };
    _.kk = function (a) {
      _.ak(a, _.Vj) || _.ak(a, _.Wj)
        ? (a = _.gk(a))
        : a instanceof _.lc
        ? (a = _.gk(_.mc(a)))
        : "function" == typeof _.Dj && a instanceof _.Dj
        ? (a = _.gk(_.Fj(a).toString()))
        : ((a = String(a)),
          (a = hk.test(a) ? a.replace(_.ik, _.jk) : "about:invalid#zSoyz"));
      return a;
    };
    _.ak = function (a, b) {
      return a != null && a.zc === b;
    };
    lk = {
      "\x00": "&#0;",
      "\t": "&#9;",
    ...
    bk = /[\x00\x22\x26\x27\x3c\x3e]/g;
    nk = /[\x00\x22\x27\x3c\x3e]/g;
    _.ik =
      /[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g;
    hk =
      /^[^&:\/?#]*(?:[\/?#]|$)|^https?:|^ftp:|^data:image\/[a-z0-9+-]+;base64,[a-z0-9+\/]+=*$|^blob:/i;
    _.fk = function (a) {
      return String(a).replace(nk, ck);
    };
    _.gk = function (a) {
      return String(a).replace(_.ik, _.jk);
    };
    dk = /</g;
    _.ok = "0".codePointAt(0);
    _.pk = RegExp("'([{}#].*?)'", "g");
    _.qk = RegExp("''", "g");
    var Nj = {};
    _.rk = function (a) {
  ...
  try {
    ...
    _.wk = function (a, b, c) {
      ...
      if (b && _.K(b, 7) === 2) {
        ...
        b && _.K(b, 10) === 2 && !_.U("disable_personalized_button")
          ? ((c = c === void 0 ? !0 : c),
            b && _.zd(b, _.yj, 8)
              ? ((d = {}),
                b &&
    ...
    Ak = function (a) {
      return _.ak(a, yk) ? zk(a.wb, !1) : a == null ? "" : zk(String(a), !0);
    };
    Bk = function () {
      return (0, _.V)(
  ...
  try {
    ...
    of = function (a, b) {
      if (typeof a === "string") return { buffer: nf(a), ya: b };
      if (Array.isArray(a)) return { buffer: new Uint8Array(a), ya: b };
      if (a.constructor === Uint8Array) return { buffer: a, ya: !1 };
      if (a.constructor === ArrayBuffer)
        return { buffer: new Uint8Array(a), ya: !1 };
      if (a.constructor === _.Bb)
        return { buffer: a.h() || new Uint8Array(0), ya: !0 };
        ...
        if (
          ...
          (g == null ||
            g.g(function (p, q, r) {
              if (r.length !== 0)
                if (k[q])
                  for (p = _.u(r), q = p.next(); !q.done; q = p.next()) {
                    q = sf(q.value);
                    try {
                      (h = !0), e(f, q);
                    } finally {
          ...
          var m = a[_.x] | 0;
          if (m & 2 && m & 16384) throw Error();
          var n = m & 512 ? _.ac : void 0;
          _.eb(f, f[_.x] | 0, function (p, q) {
            if (_.Mb(a, m, p, n) != null)
              switch (b == null ? void 0 : b.Ee) {
                case 1:
                  return;
                default:
                  throw Error();
    ...
    wf = function (a) {
      var b = a[rf];
      if (b != null) return b;
      var c = _.Xb(qf, pf, vf, a);
      b = c.Tc
        ? function (d, e) {
            return (0, _.Ub)(d, e, c);
          }
        : function (d, e) {
            for (var f = d[_.x] | 0; xf(e) && e.h != 4; ) {
              var g = e.j,
                h = c[g];
              if (h == null) {
                var k = c.Jb;
                k && (k = k[g]) && ((k = yf(k)), k != null && (h = c[g] = k));
              }
              if (h == null || !h(e, d, g)) {
                h = e;
                k = h.i;
                zf(h);
                var m = h;
                if (m.Fb) var n = void 0;
                else
                  (h = m.g.g - k),
                    (m.g.g = k),
                    (m = m.g),
                    h == 0
                      ? (h = Af || (Af = new _.Bb(null, Bf)))
                      : ((k = Cf(m, h)),
                        m.hb && m.l
                          ? (h = m.i.subarray(k, k + h))
                          : ((m = m.i),
                            (h = k + h),
                            (h =
                              k === h
                                ...
                                : _.td
                                ? m.slice(k, h)
                                : new Uint8Array(m.subarray(k, h)))),
                        (h =
                          h.length == 0
                            ? Af || (Af = new _.Bb(null, Bf))
                            : new _.Bb(h, Bf))),
                    (n = h);
                m = k = h = void 0;
                var p = d;
                n &&
                  ((h = (k =
                    (m = p[_.tb]) != null ? m : (p[_.tb] = new _.wb()))[g]) !=
                  null
                    ? h
                    : (k[g] = [])
                  ).push(n);
    ...
    _.Ef = function (a) {
      switch (_.K(a, 1)) {
        case 1:
          _.F("The specified user is not signed in.");
          break;
        case 2:
          _.F("User has opted out of using Google Sign In.");
          break;
        case 3:
          _.F("The given client ID is not found.");
          break;
        case 4:
          _.F("The given client ID is not allowed to use Google Sign In.");
          break;
        case 5:
          _.F("The given origin is not allowed for the given client ID.");
          break;
        case 20:
          _.F("The given login_uri is not allowed for the given client ID.");
          break;
        case 6:
          _.F("Request from the same origin is expected.");
          break;
        case 7:
          _.F("Google Sign In is only allowed with HTTPS.");
          break;
        case 8:
          _.F("Parameter " + _.J(a, 2) + " is not set correctly.");
          break;
        case 9:
          _.F("The browser is not supported.");
          break;
        case 12:
          _.F("Google Sign In does not support web view.");
          break;
        case 14:
          _.F("The client is restricted to accounts within its organization.");
          break;
        default:
          _.F("An unknown error occurred.");
      }
    };
    Bf = {};
    Ff = void 0;
    ...
    jf = { "-": "+", _: "/", ".": "=" };
    _.Bb = function (a, b) {
      if (b !== Bf) throw Error("v");
      this.g = a;
      if (a != null && a.length === 0) throw Error("u");
    };
    _.Bb.prototype.i = function () {
      var a = this.g;
      if (a == null) a = "";
    ...
    _.Bb.prototype.pb = function () {
      return this.g == null;
    };
    _.Bb.prototype.h = function () {
      if (Bf !== Bf) throw Error("v");
      var a = this.g;
      a =
        a == null || (_.id && a != null && a instanceof Uint8Array)
          ? a
          : typeof a === "string"
          ? nf(a)
          : null;
    ...
    _.wb = function () {};
    _.wb.prototype.g = function (a) {
      for (var b in this) !isNaN(b) && a(this, +b, this[b]);
    };
    _.wb.prototype.i = function () {
      var a = new _.wb();
    ...
    var Mf = [],
      Of = function (a) {
        for (var b = 0, c = a.g, d = c + 10, e = a.i; c < d; ) {
          var f = e[c++];
          b |= f;
          if ((f & 128) === 0) return Nf(a, c), !!(b & 127);
        }
        throw Error("L");
      },
      Pf = function (a, b, c, d) {
    ...
    Pf.prototype.init = function (a, b, c, d) {
      var e = d === void 0 ? {} : d;
      d = e.hb === void 0 ? !1 : e.hb;
      e = e.sb === void 0 ? !1 : e.sb;
      this.hb = d;
      this.sb = e;
      a &&
        ((a = of(a, this.sb)),
        ...
        (this.l = a.ya),
        (this.j = b || 0),
        (this.h = c !== void 0 ? this.j + c : this.i.length),
        (this.g = this.j));
    };
    ...
    Nf = function (a, b) {
      a.g = b;
      if (b > a.h) throw Error("M`" + b + "`" + a.h);
    };
    Cf = function (a, b) {
      if (b < 0) throw Error("N`" + b);
      var c = a.g,
        d = c + b;
      if (d > a.h) throw Error("M`" + (a.h - c) + "`" + b);
      a.g = d;
      return c;
    };
    _.Qf = function (a) {
    ...
    var xf = function (a) {
        ...
        b = c >>> 3;
        c &= 7;
        if (!(c >= 0 && c <= 5)) throw Error("H`" + c + "`" + a.i);
        if (b < 1) throw Error("I`" + b + "`" + a.i);
        a.j = b;
        a.h = c;
        return !0;
      },
      zf = function (a) {
        switch (a.h) {
          ...
          case 3:
            b = a.j;
            do {
              if (!xf(a)) throw Error("J");
              if (a.h == 4) {
                if (a.j != b) throw Error("K");
                break;
              }
              zf(a);
            } while (1);
    ...
    Uf.prototype.o = function () {
      ...
      if (_.Ec) {
        var d = b,
          e;
        (e = Gf) || (e = Gf = new TextDecoder("utf-8", { fatal: !0 }));
        b = c + a;
        ...
        try {
          ...
          if (Ff === void 0) {
            ...
            try {
              e.decode(new Uint8Array([97])), (Ff = !0);
            } catch (n) {
              Ff = !1;
            }
          }
        ...
        for (var g = null, h, k; c < a; )
          (h = b[c++]),
            h < 128
              ...
              : gf(),
            f.length >= 8192 && ((g = hf(g, f)), (f.length = 0));
        f = hf(g, f);
      }
      return f;
    };
  ...
  try {
    ...
    _.cl = function (a, b) {
      var c = 0;
      a = (0, _.Ic)(String(a)).split(".");
      b = (0, _.Ic)(String(b)).split(".");
    ...
    _.el = function () {
      return _.Ha() ? _.va.platform === "Android" : _.w("Android");
    };
    _.fl = function () {
      return _.Ha() ? _.va.platform === "Chrome OS" : _.w("CrOS");
    };
    _.il = function () {
      return ![_.Ea() && !_.gl() && !_.hl(), _.Ea() && _.el(), _.Ba()].some(
        function (a) {
          return a;
        }
      );
    ...
    _.jl = function () {
      ...
      if (
        ...
        a = _.ta();
        var b = "";
        (_.Ha() ? _.va.platform === "Windows" : _.w("Windows"))
    ...
    _.hl = function () {
      return _.ua && _.va
        ? !_.va.mobile && (_.w("iPad") || _.w("Android") || _.w("Silk"))
        : _.w("iPad") || (_.w("Android") && !_.w("Mobile")) || _.w("Silk");
    };
    var kl;
    kl = {};
    _.ll =
      ((kl.test_list = ["test_client_id"]),
      (kl.cross_origin_iframe_rps =
  ...
  try {
    var Ap;
    _.Cp = function (a) {
      if (Ap && a.dataset) return a.dataset;
      var b = {};
      a = a.attributes;
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (d.name.lastIndexOf("data-", 0) == 0) {
          var e = _.Bp(d.name.slice(5));
          b[e] = d.value;
        }
      }
      return b;
            ...
            if (g) {
              ...
              switch (g) {
                ...
                case "origin":
                  ...
                  break;
                default:
                  _.F("Unrecognized type. Configuration ignored.");
              }
            }
          }
        }
  ...
  try {
    _.Ep = function (a, b, c) {
      ...
      _.C("Message sent to " + c + ". " + JSON.stringify(b), "Message Util");
      a.postMessage(b, c);
    };
  } catch (e) {
    _._DumpException(e);
  ...
  try {
    ...
    _.Fp = function () {
      ...
      (window.crypto || _.Se.msCrypto).getRandomValues(a);
      return a[0].toString(16) + a[1].toString(16);
    };
    _.Hp = function (a) {
      _.Ep(window.parent, a, _.Gp);
    };
    _.Op = function (a, b, c) {
      Ip
        ? _.E(
        ...
        : _.Gp
        ? (_.C("Parent origin has already been verified."), b && b())
        : Jp(a)
        ? ((Kp = a),
          Lp(),
          (a = _.Fp()),
    ...
    Jp = function (a) {
      ...
      if (typeof a === "string") return Pp(a);
      if (Array.isArray(a)) {
        for (var b = 0; b < a.length; b++)
          if (typeof a[b] !== "string" || !Pp(a[b])) return !1;
        return !0;
      }
      return !1;
    };
    Pp = function (a) {
      try {
        ...
        a = c;
        b = "Ob";
        if (Qp.Ob && Qp.hasOwnProperty(b)) var d = Qp.Ob;
        else {
          var e = new Qp();
          d = Qp.Ob = e;
        }
    ...
    Lp = function () {
      Sp ||
        (Sp = _.O(window, "message", function (a) {
          a = a.g;
          if (a.data) {
            var b = a.data;
            b.sentinel === "onetap_google" &&
              b.command === "parent_frame_ready" &&
              (_.C("Message received: " + JSON.stringify(b)),
              window.parent && window.parent === a.source
                ? Ip
                  ? b.nonce !== Ip
                    ? _.E("Message ignored due to invalid nonce.")
                    : (Tp(a.origin)
                        ? ((_.Gp = a.origin),
                          (_.Up = b.parentMode || "amp_client"),
                          Mp && Mp())
                        : (_.E(
                          ...
                          Np && Np()),
                      (Np = Mp = Ip = void 0),
                      Sp && (_.Me(Sp), (Sp = void 0)))
                  : _.E(
                      "Message ignored. Origin verifier is not ready, or already done."
                    )
                : _.E("Message ignored due to invalid source."));
          }
        }));
    };
    Tp = function (a) {
      return typeof Kp === "string"
        ? Vp(Kp, a)
        : Array.isArray(Kp)
        ? Kp.some(function (b) {
            return Vp(b, a);
    ...
    _.Wp = function (a) {
      _.Gp
        ? _.Hp({ command: "intermediate_iframe_resize", height: a })
        : _.E(
    ...
    _.Xp = function () {
      _.Gp
        ? _.Hp({ command: "intermediate_iframe_close" })
        : _.E(
    ...
    _.Yp = function (a) {
      _.Gp
        ? _.Hp({ command: "set_tap_outside_mode", cancel: a })
        : _.E(
    ...
    Zp.prototype.set = function (a, b) {
      $p(this, a, b, !1);
    };
    Zp.prototype.add = function (a, b) {
      $p(this, a, b, !0);
    };
    var $p = function (a, b, c, d) {
      ...
      if (d && a.g !== void 0) throw Error("Ga`" + b);
      a.g = c;
    };
    Zp.prototype.get = function (a) {
      a: {
        for (var b = this, c = 0; c < a.length; c++)
          if (((b = b.M[a.charAt(c)]), !b)) {
            a = void 0;
            break a;
          }
        a = b;
    ...
    var bq = function (a, b, c) {
      a.g !== void 0 && c.push(b);
      for (var d in a.M) bq(a.M[d], b + d, c);
    };
    Zp.prototype.clear = function () {
      this.M = {};
      this.g = void 0;
    };
    Zp.prototype.remove = function (a) {
      for (var b = this, c = [], d = 0; d < a.length; d++) {
        var e = a.charAt(d);
        if (!b.M[e]) throw Error("Ha`" + a);
        c.push([b, e]);
        b = b.M[e];
      }
      a = b.g;
      for (delete b.g; c.length > 0; )
        if (((d = c.pop()), (b = d[0]), (d = d[1]), b.M[d].pb())) delete b.M[d];
        else break;
      return a;
    };
    Zp.prototype.pb = function () {
      var a;
      if ((a = this.g === void 0))
        a: {
          for (var b in this.M) {
    ...
    var Qp = function () {
      ...
      dq = function (a, b, c) {
        ...
        a++;
        if (d == "?" || d == ",") return a;
        do (a = dq(a, b, c)), (d = b.charAt(a));
        while (d != "?" && d != ",");
        return a + 1;
      };
    var Kp, Sp, Ip, Mp, Np;
    _.H("google.accounts.id.intermediate.verifyParentOrigin", _.Op);
    _.H("google.accounts.id.intermediate.notifyParentResize", _.Wp);
    _.H("google.accounts.id.intermediate.notifyParentClose", _.Xp);
    _.H("google.accounts.id.intermediate.notifyParentDone", function () {
      _.Gp
        ? _.Hp({ command: "intermediate_iframe_done" })
        : _.E(
            "Done command was not sent due to missing verified parent origin."
          );
    });
    _.H("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.Yp);
  } catch (e) {
    _._DumpException(e);
  }
  try {
    var eq = function (a) {
        var b = b === void 0 ? _.Jd : b;
        a: if (((b = b === void 0 ? _.Jd : b), !(a instanceof _.lc))) {
          for (var c = 0; c < b.length; ++c) {
            var d = b[c];
            if (d instanceof _.nc && d.Ld(a)) {
              a = new _.lc(a);
              break a;
            }
          }
      ...
      gq = function (a, b) {
        if (_.Ej(b)) (a.href = _.Fj(b).toString()), (a.rel = "stylesheet");
        else {
          if (fq.indexOf("stylesheet") === -1) throw Error("S`stylesheet");
          b = _.qc(b);
      ...
      hq = function () {
        var a = _.Fp().toString(),
          b = { Rb: 300, path: "/", Yb: !0 },
          c;
        if ((c = _.Ea())) c = _.cl(_.Re, 80) >= 0;
        c && (b.Xb = "none");
        c = _.ce(location.origin);
        c.h === "http" &&
          c.g === "localhost" &&
          ((b.Yb = void 0), (b.Xb = void 0));
        _.ne.set("g_csrf_token", a, b);
        return a;
      },
      iq = function (a, b) {
        _.rj(
      ...
      mq = function (a) {
        try {
          var b = _.ce(a),
            c = b.h;
          return (
            !!b.g && (c === "https" || (c === "http" && b.g === "localhost"))
          );
        } catch (d) {}
        return !1;
      },
      nq = function () {
        ...
        for (b = a.next(); !b.done; b = a.next())
          if (
            ...
            return _.ce(b).j.get("client_id") || null;
        return null;
      },
      oq = function (a) {
        if (!a) return null;
      ...
      qq = function (a, b, c) {
        ...
        if (c.enable_granular_consent !== void 0)
          var q = c.enable_granular_consent;
        c = [];
        pq(c, "gsiwebsdk", "3");
        pq(c, "client_id", d);
        pq(c, "scope", e);
        ...
        pq(c, "include_granted_scopes", p === !1 ? "false" : "true");
        pq(c, "enable_granular_consent", q === !1 ? "false" : "true");
        return b + "?" + c.join("&");
      },
      rq = function (a, b) {
        var c = [];
        c.push(_.O(a, "click", b));
        c.push(
          _.O(a, "keydown", function (d) {
            var e = d.key;
            (e !== "Enter" && e !== " ") || b(d);
          })
        );
      ...
      xq = function (a) {
        var b = document;
        if (!b.location.ancestorOrigins) return !1;
        var c = b.location.protocol + "//" + b.location.host;
        if (a === void 0 ? 0 : a) return c !== wq();
        a = _.u(b.location.ancestorOrigins);
        for (b = a.next(); !b.done; b = a.next()) if (b.value !== c) return !0;
        return !1;
      },
      Bq = function (a, b, c) {
        yq = a ? a + "/gsi/log" : "https://accounts.google.com/gsi/log";
        zq = b;
        Aq = c;
      },
      Dq = function (a, b) {
        Cq >= (b === void 0 ? 100 : b) ||
          ((b = new _.Pd(yq)),
          _.Sd(b, _.Yi({ client_id: zq, as: Aq, event: a.toString() })),
          _.rj(
            b.toString(),
            void 0,
            "POST",
            void 0,
            void 0,
            yq !== "https://accounts.google.com/gsi/log"
          ));
      },
      Hq = function (a) {
        var b = new (Function.prototype.bind.apply(
          Eq,
          [null, "onetap", a, "prompt"].concat(Fq(Gq.apply(1, arguments)))
        ))();
        Dq(b);
      },
      Iq = function () {
        var a = new (Function.prototype.bind.apply(
          Eq,
          [null, "onetap", void 0, "closed"].concat(Fq(Gq.apply(0, arguments)))
        ))();
        Dq(a);
      },
      Jq = function () {
        var a = new (Function.prototype.bind.apply(
          Eq,
          [null, "id", void 0, "init"].concat(Fq(Gq.apply(0, arguments)))
        ))();
        Dq(a);
      },
      Kq = function () {
        var a = new (Function.prototype.bind.apply(
          Eq,
          [null, "onetap", void 0, "policy"].concat(Fq(Gq.apply(0, arguments)))
        ))();
        Dq(a);
      },
      Lq = function (a) {
        ...
        var b = _.Cj();
        return new _.Dj(b ? b.createScriptURL(a) : a);
      },
      Nq = function (a) {
        var b = b === void 0 ? "googleidentityservice" : b;
        if (!(document.getElementById(b) && Mq.get(b) && Mq.get(b))) {
          var c = new _.Pg(),
      ...
      Tq = function () {
        return (
          "gsi_" + (Date.now() % 1e6) + "_" + Math.floor(Math.random() * 1e6)
        );
      },
      Vq = function (a) {
        var b = _.N("g_a11y_announcement");
        b ||
          ((b = _.Ld(document, "div")),
          (b.id = "g_a11y_announcement"),
          document.body.appendChild(b));
        var c = _.Ld(document, "span");
        Uq(c, a);
        c.role = "alert";
        _.Sj(b);
        b.appendChild(c);
      ...
      Xq = function (a, b, c) {
        ...
        Bq(b, a, c);
        var f = _.O(document, "securitypolicyviolation", function (g) {
          g = g.g;
          g.blockedURI &&
            ...
            Kq(
              "cspHeaderViolation",
              "topOrigin=" +
                (g > 0 ? document.location.ancestorOrigins[g - 1] : "")
            ),
            _.Me(f));
        });
        b = new _.Pd(e);
        _.Sd(b, _.Yi({ client_id: a, as: c }));
        _.rj(b.toString(), void 0, "POST", void 0, void 0, e !== d);
      },
      Yq = function (a) {
        this.g = a;
        this.h = null;
      ...
      fr = function () {
        ...
        if (a) {
          ...
          for (d in b)
            b.hasOwnProperty(d) &&
              br.indexOf(d.toLowerCase()) < 0 &&
              (c[d] = b[d]);
          a.state && (c.state = a.state);
          if ((d = a.login_uri)) {
            b = _.ce(d);
            b.g ||
              (_.Qd(b, location.protocol),
              (b.g = location.hostname),
              _.Rd(b, location.port),
              Jq("relativeLoginUri", d),
              _.E(
            ...
            if (b.h !== "https" && b.g !== "localhost")
              throw (
                (Jq("unsecuredLoginUri", d),
                new cr("Unsecured login_uri provided."))
              );
            d = b.toString();
            a.login_uri = d;
            a.redirect_callback = dr(d, c);
      ...
      dr = function (a, b) {
        return function (c) {
          c && c.credential
            ? lq(a, b, c.credential)
            : _.D("No credential found in the response.");
        };
      },
      er = function (a, b, c, d) {
        return function (e) {
          e && e.type === "password"
            ? ((b[c] = e.id), (b[d] = e.password), _.zg(a, b))
            : _.D("No password credential returned.");
        };
      },
      hr = function (a) {
        a = _.Cp(a);
      ...
      mr = function (a) {
        a = new ir(a);
        jr.__G_ID_CLIENT__ = a;
        Nq(a.Md);
        kr(a);
        (_.U("enable_fedcm_button") ||
          _.U("enable_fedcm_button_global_experiment")) &&
          tq(
            "fedcmButtonToken",
            "A8o5T4MyEkRZqLA9WeG2XTFdV5tsX2Prg85xyQ+RL1btVuybB1K/EQ+7JUsPK+J32oBMTnsoF9B4A+qTlL6efgQAAABweyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENtQnV0dG9uTW9kZSIsImV4cGlyeSI6MTc0NDY3NTIwMCwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ=="
          );
        lr(a.A);
        return a;
      },
      nr = function (a, b, c) {
        var d = jr.__G_ID_CLIENT__;
        d || (mr(), (d = jr.__G_ID_CLIENT__));
        d.ha(a, b, c);
      },
      pr = function (a, b, c) {
        if (a && b) {
          ...
          d
            ? or(d, a, b, c)
            : _.E("Failed to render button before calling initialize().");
        } else
          _.E(
      ...
      rr = function () {
        var a = jr.__G_ID_CLIENT__;
        a || (mr(), (a = jr.__G_ID_CLIENT__));
        qr(a.u);
      },
      sr = function () {
        var a = a === void 0 ? document.readyState : a;
        for (var b = _.Qj("g_id_signout"), c = 0; c < b.length; c++)
          _.O(b[c], "click", rr);
        try {
          var d = fr();
          if (d) {
          ...
          var g = _.Qj("g_id_signin");
          for (a = 0; a < g.length; a++) {
            var h = hr(g[a]);
            pr(g[a], h);
          }
        } catch (k) {
          _.F("Error parsing configuration from HTML: " + k.message);
        }
      },
      tr = function () {
        var a = jr.onGoogleLibraryLoad;
          ...
          for (var c = a.next(); !c.done; c = a.next()) {
            ...
            !d && d.indexOf(" ") >= 0
              ? (_.E(
                ...
                (c = null))
              : (c = d);
            if (c === null) return _.E("Invalid scope found."), null;
            c && b.push(c);
          }
        }
        return b;
      ...
      wr = function (a) {
        return (a = a && a.scope && a.scope.trim())
          ? vr.apply(null, Fq(a.split(" ")))
          : null;
      },
      xr = function (a) {
        _.Xf(a, "prompt_closed", { xe: !1 });
      },
      yr = function (a, b, c) {
        b = { Ce: b };
        c !== void 0 && (b.De = c);
        _.Xf(a, "prompt_resized", b);
      },
      Fq = function (a) {
      ...
      Cr;
    _.G(cr, Error);
    Br = { se: "signin", te: "signup", ve: "use" };
    Cr = { oe: "card", ne: "bottom_sheet" };
    _.Dj = function (a) {
      this.g = a;
    };
    ...
    Eq.prototype.toString = function () {
      ...
      this.h && a.push.apply(a, Fq(this.h));
      return a.join(".");
    };
    var Cq = Math.floor(Math.random() * 100),
      yq = "https://accounts.google.com/gsi/log",
      zq,
      Aq;
    var Mq = new Map();
    var Ir = function () {
      ...
      Kr = function (a, b, c) {
        c = c === void 0 ? "widget" : c;
        _.C("Starting FedCM call. Mode: " + c + " | callId: " + a.g + ".");
        navigator.credentials
          .get(Jr(a, b, c))
          .then(
            function (d) {
              _.C("Response received. callId: " + a.g + ".");
              a.sa(b, c, d);
            },
            function (d) {
              _.C("Error received. callId: " + a.g + ".");
              b.za(c, d);
            }
          )
          .finally(function () {
      ...
      Jr = function (a, b, c) {
        _.C("Generating FedCM options. callId: " + a.g + ".");
        ...
        _.U("enable_fedcm_domain_hint") &&
          b.m.hosted_domain &&
          (d.domainHint =
            b.m.hosted_domain === "*" ? "any" : b.m.hosted_domain);
        d = {
          context: b.m.context || "signin",
          providers: [d],
          mode: _.bg() >= 131 ? (c === "button" ? "active" : "passive") : c,
        };
        var e = { signal: a.h.signal, federated: d, identity: d };
        e.mediation = b.Ja ? "optional" : "required";
        c === "widget" && (d.autoReauthn = !!b.Ja);
        _.C("FedCM options generated. callId: " + a.g + ". " + e);
        return e;
      };
    Ir.prototype.sa = function (a, b, c) {
      c
        ? (_.C("Processing FedCM response. callId " + this.g),
          c.login
            ? c.login({ signal: this.h.signal, nonce: a.m.nonce }).then(
                function (d) {
                  a.sa(b, d, a.mb);
                },
                function (d) {
            ...
            : a.sa(b, c, a.mb))
        : (_.C("FedCM credential is null. callId " + this.g),
          a.za(b, Error("Ia")));
    };
    var Lr = function () {
        this.h = !1;
      ...
      lr = function (a) {
        _.C("Evaluating FedCM mode support.");
        var b = {
          identity: Object.defineProperty({}, "mode", {
            get: function () {
              _.C("FedCM mode supported.");
              a.h = !0;
            },
          }),
        };
    ...
    var Pr = { left: 1, center: 2 },
      Qr = { rectangular: 1, square: 3, pill: 2, circle: 4 },
      Rr = { large: 1, medium: 2, small: 3 },
      Sr = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
      Tr = { outline: 1, filled_blue: 2, filled_black: 3 },
      Ur = { standard: 1, icon: 2 },
      Vr = function (a, b, c) {
        this.container = a;
        this.h = c;
        this.g = !1;
        ...
        if (
          b &&
          (b.logo_alignment && _.S(a, 6, Pr[b.logo_alignment]),
          b.shape && _.S(a, 3, Qr[b.shape]),
          b.size && _.S(a, 1, Rr[b.size]),
          b.text && _.S(a, 5, Sr[b.text]),
          b.theme && _.S(a, 2, Tr[b.theme]),
          b.type && _.S(a, 7, Ur[b.type]),
          b.width)
        )
          if (typeof b.width === "number" && !isNaN(b.width))
            _.Gg(a, 4, Number(b.width));
          else if (typeof b.width === "string")
            try {
              var d = b.width;
              _.Gg(a, 4, Number(d.endsWith("px") ? d.slice(0, -2) : d));
            } catch (e) {
              _.E("Provided button width is invalid: " + b.width);
            }
        this.Ia = a;
      ...
      Wr = function (a) {
        if (!a.g) {
          _.wk(a.container, a.Ia);
          var b = _.Rj("nsm7Bb-HzV7m-LgbsSe", a.container);
          b &&
            a.h &&
            rq(b, function () {
              a.h && a.h.call(a);
    ...
    Vr.prototype.dispose = function () {
      if (!this.g) {
        var a = _.Rj("nsm7Bb-HzV7m-LgbsSe", this.container);
        a && _.Tj(a);
        this.g = !0;
    ...
    var Yr = [0, 7200, 86400, 604800, 2419200],
      Zr = function (a, b, c) {
        this.i = a;
      ...
      bs = function (a, b) {
        var c = a.g + "p",
          ...
          e = a.g + "l",
          f = $r(a);
        b.disable_auto_prompt === void 0
          ? delete f[c]
          : (f[c] = b.disable_auto_prompt);
        b.disable_auto_select_to === void 0
          ? delete f[d]
          : (f[d] = b.disable_auto_select_to);
        f[e] = b.prompt_suppress_level;
        b = JSON.stringify(f);
        c = _.el() && _.Ea() && _.cl(_.dl(), "67") >= 0;
        _.ne.set(a.h, b, {
          Rb: 15552e3,
          path: "/",
          domain: a.i || void 0,
    ...
    gs.prototype.Ha = function () {
      return new hs(this.g());
    };
          ...
          try {
            ...
            c =
              ...
              (d.name === "QuotaExceededError" ||
                d.code === 22 ||
                d.code === 1014 ||
                d.name === "NS_ERROR_DOM_QUOTA_REACHED") &&
              b &&
              b.length !== 0;
          }
        else c = !1;
    ...
    var ns = function (a) {
      if (a.g == null) throw Error("Ka");
      var b;
      (_.Mc ? ms(a) : (b = a.h) != null ? b : ms(a)) || _.sa(Error("Ka"));
    };
    _.Dc(Zq, Yq);
    _.Dc($q, ls);
    ...
    var os = new _.Gd("g_credential_picker"),
      qs = function (a, b) {
        b = b === void 0 ? "i_" : b;
        var c = new Zq();
        this.O = ms(c) ? new $q(c, "g_state_id_") : null;
        this.Nd = b;
        this.g = a = Object.assign({}, a);
        this.rc = !1;
        this.F = !0;
        b = new Uint8Array(32);
        (window.crypto || _.Se.msCrypto).getRandomValues(b);
        this.i = btoa(String.fromCharCode.apply(String, Fq(b))).replace(
          /=+$/,
          ""
        );
        this.H = new Map();
    ...
    _.G(qs, _.Vf);
    var ps = function (a, b) {
      var c = a.O ? a.O.get("ll") || void 0 : void 0;
      if (c) rs(a, c);
      else {
        if ((c = b.log_level !== void 0))
          (c = b.log_level), (c = c === void 0 || (0, _.La)(Dr, c) >= 0);
        c && rs(a, b.log_level);
      }
      a.Id = b.button_url || "https://accounts.google.com/gsi/button";
      a.Cc = b.picker_url || "https://accounts.google.com/gsi/select";
      a.Pd = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
      a.Pc = b.status_url || "https://accounts.google.com/gsi/status";
      a.B = _.Nd(a.Pc);
      ...
      a.Ea = b.fedcm_config_url || "https://accounts.google.com/gsi/fedcm.json";
      a.Ga =
        b.oauth2_auth_url || "https://accounts.google.com/o/oauth2/v2/auth";
      Bq(a.B, b.client_id, a.i);
      a.callback = b.callback;
      a.Dc = b.redirect_callback;
      a.T = b.ux_mode === "redirect" ? "redirect" : "popup";
      c = b.ui_mode;
      (c !== void 0 && Object.values(Cr).includes(c)) ||
        ((c = a.container === document.body),
        (c =
          (_.gl() && !_.hl()) ||
          ((c === void 0 || c) && vq() && window.innerWidth < 420)
            ? "bottom_sheet"
            : "card"));
      a.J = c;
      a.container =
      ...
      a.pc = b.itp_support !== !1;
      a.s =
        b.use_fedcm_for_prompt === void 0 ? void 0 : !!b.use_fedcm_for_prompt;
      a.Td =
        b.use_fedcm_for_button === void 0 ? void 0 : !!b.use_fedcm_for_button;
      a.cb =
        b.enable_redirect_uri_validation === void 0
          ? void 0
          : !!b.enable_redirect_uri_validation;
      if (b.library_name && b.library_name.length > 100) throw Error("La");
      a.qc = b.library_name ? b.library_name : void 0;
      c = b.state_cookie_domain;
      !c || (c != null && ds.test(c)) || (c = void 0);
      a.u = new Zr(c, a.Nd, b.state_cookie_name);
      a.wc(b);
      c = {};
      ...
      b.button_auto_select !== void 0 &&
        (c.button_auto_select = b.button_auto_select);
      c.ux_mode = a.T;
      c.ux_mode === "redirect" && b.login_uri && (c.login_uri = b.login_uri);
      c.ui_mode = a.J;
      b.context !== void 0 &&
        Object.values(Br).includes(b.context) &&
        (c.context = b.context);
      ...
      _.dc !== "warn" && (c.log_level = _.dc);
      b.hl !== void 0 && (c.hl = b.hl);
      b.disable_auto_focus !== void 0 &&
    ...
    qs.prototype.wc = function () {};
    qs.prototype.uc = function () {};
    var kr = function (a) {
        a.rc ||
          ((a.rc = !0),
          _.O(
      ...
      ws = function (a) {
        setTimeout(function () {
          a.ma = _.O(document, "click", function () {
            a.bb && ts(a, !1) && (us(a, "tap_outside"), vs(a));
          });
        });
      },
      vs = function (a) {
        a.ma && (_.Me(a.ma), (a.ma = void 0));
      },
      xs = function (a) {
        var b;
        (b = _.U("disable_fedcm")) ||
        ...
        if (wq() === "https://meet.google.com") return !1;
        if (_.U("enable_fedcm_global_experiment"))
          return _.C("In FedCM global experiment group"), !0;
        if (_.U("enable_fedcm_global_control"))
          return _.C("In FedCM global control group"), !1;
        var c = a.m.client_id;
        b =
          (_.U("enable_fedcm_cross_origin_iframe") &&
            !_.ll.cross_origin_iframe_rps.includes(c)) ||
          _.U("enable_forced_fedcm_cross_origin_iframe");
        if (
          (xq() && !a.s && !b) ||
          (a.s && a.m.auto_select && !(_.bg() >= 121)) ||
          (a.m.hosted_domain && !_.U("enable_fedcm_domain_hint") && !a.s)
        )
          return !1;
        (b = a.s === !1) &&
          _.E(
        ...
        c =
          (_.U("enable_fedcm_csp") && !_.ll.csp_rps.includes(c)) ||
          _.U("enable_forced_fedcm_cross_origin_iframe");
        a =
          (_.U("enable_manual_fedcm_launch") || c) &&
          (_.U("enable_fedcm_auto_reauthn") || !a.m.auto_select);
        return !b && (d || a);
      },
      ys = function (a) {
        return uq() && a.A.h && !_.U("enable_fedcm_button_global_control")
          ? _.U("enable_fedcm_button_global_experiment")
            ? !0
            : _.U("enable_fedcm_button")
            ? !!a.Td
    ...
    qs.prototype.sa = function (a, b, c) {
      if (b) {
        _.C("Processing FedCM credential");
        var d = b.token;
        if (typeof d === "object" && "token" in d) {
          ...
          if (c) {
            if (c.state !== e.state) {
              _.E(
                "State returned by FedCM does not match the state sent. Response will not be processed."
              );
              return;
            }
            if (c.login_uri !== e.loginUri) {
              _.E(
                "Login Uri returned by FedCM does not match the state sent. Response will not be processed."
              );
              return;
            }
          }
        } else d = b.token;
        d = { credential: b && (b.idToken || d) };
        d.select_by =
          a === "widget"
            ? b.isAutoSelected
              ? "fedcm_auto"
            ...
            ? "fedcm_button_auto"
            : "fedcm_button";
        zs({ data: { announcement: _.rk({}) } });
        _.C("FedCM response :" + JSON.stringify(d));
        a === "widget"
          ? (this.callback
              ? this.callback.call(this, d)
              : _.C("No callback found for FedCM widget flow"),
            As(this, "credential_returned"))
          : (c && c.state && (d.state = c.state),
            this.T === "popup"
              ? this.callback
                ? this.callback.call(this, d)
                : _.C("No callback found for FedCM button popup flow")
              : c && c.login_uri
              ? ((a = {}),
                c && c.state && (a.state = c.state),
                lq(c.login_uri, a, d.credential))
              : this.Dc
              ? this.Dc.call(this, d)
              : _.C("No callback found for FedCM button redirect flow."));
      } else _.C("FedCM credential is null");
    };
    qs.prototype.za = function (a, b) {
      _.F("FedCM get() rejects with " + b);
      a === "widget" && us(this, "unknown_reason");
    };
    qs.prototype.ha = function (a, b, c) {
      var d = this;
      ...
      _.U("enable_fedcm_csp_compliance_detection") &&
        Xq(this.g.client_id ? this.g.client_id : "", this.B, this.i);
      window.location.href.startsWith("chrome-extension://")
        ? (_.E("Attempted to start sign in flow inside chrome extension."),
          Hq(b, "chromeExtension"))
        : (ts(this, !0) && As(this, "flow_restarted"),
          a &&
            !this.oc &&
            (_.E(
          ...
          this.m.client_id
            ? _.U("unsupported_browser")
              ? (_.D("One Tap is not supported in this User Agent."),
                this.j("browser_not_supported"),
                _.Yf(this, "prompt_display_failed", {
              ...
              ? (_.D(
                ...
                Hq(
                  b,
                  "cooldown",
                  (as(this.u).prompt_suppress_level || 0).toString()
                ))
              : xs(this)
              ? ((this.G = !0),
                (a = {
                  as: this.i,
                  top_origin: xq(!0) ? wq() : void 0,
                  library_name: this.m.library_name
                    ? this.m.library_name
                    : void 0,
                }),
                _.U("enable_unicorn_in_fedcm_onetap") &&
                  ((a.response_type = "id_token"),
                  (a.ss_domain = this.m.origin || location.origin),
                  (a.scope = "email profile openid"),
                  (a.nonce = this.m.nonce ? this.m.nonce : "not_provided"),
                  (a.state = this.m.state)),
                Nr(this.A, {
                  Gc: this.eb,
                  Fc: this.Ea,
                  m: this.m,
                  Ja: !!this.m.auto_select,
                  sa: this.sa.bind(this),
                  za: function (e, f) {
                    if (_.U("enable_fedcm_csp_and_iframe_logs")) {
                      Bq(d.B, d.g.client_id ? d.g.client_id : "", d.i);
                      var g = document.location.ancestorOrigins
                        ? document.location.ancestorOrigins.length
                        : 0;
                      ...
                      f.message.indexOf("identity-credentials-get") >= 0 &&
                        Kq(
                          "failedWithIframeGetPermission",
                          "iframeOrigin=" + h,
                          "path=" + document.location.pathname,
                          "topOrigin=" + g
                        );
                      f.message.indexOf("Content Security Policy") >= 0 &&
                        Kq(
                          "failedWithCsp",
                          "iframeOrigin=" + h,
                          "path=" + document.location.pathname,
              ...
              : Bs(this, function (e) {
                  e && _.nj(e, 3)
                    ? ((d.m.as = _.$i(_.I(e, _.sj, 1), 1) || d.m.as),
                      Cs(d),
                      Ds(d),
                      Es(d, !0),
                      ws(d))
                    ...
                    ? (_.Ef(_.I(e, _.P, 2)),
                      ...
                      _.Yf(d, "prompt_display_failed", {
                        cause:
                          "Error while checking for the credential status.",
                      }))
                    : e && !_.nj(e, 3) && _.jl() && d.pc
                    ? (_.I(e, _.sj, 1) &&
                        (d.m.as = _.$i(_.I(e, _.sj, 1), 1) || d.m.as),
                      (d.m.is_itp = !0),
                      Cs(d),
                      ...
                      delete d.m.is_itp)
                    : e && !_.nj(e, 3)
                    ? (_.C("No sessions found in the browser."),
                      d.j("opt_out_or_no_session"),
                      _.Yf(d, "prompt_display_failed", {
                        cause: "No signed in Google accounts available.",
                      }))
                    : (_.C("Invalid response from check credential status."),
                      d.j("unknown_reason"),
                      _.Yf(d, "prompt_display_failed", {
                        cause:
            ...
            : (_.F("Missing required parameter: client_id."),
    ...
    var or = function (a, b, c, d) {
        ...
        delete g.login_hint;
        g.hosted_domain =
          g.hd || g.hosted_domain || a.g.hd || a.g.hosted_domain;
        g.hosted_domain || delete g.hosted_domain;
        delete g.hd;
        g.is_fedcm_supported = uq() && a.A.h;
        if (
          _.U("enable_fedcm_button_global_control") ||
          _.U("enable_fedcm_button_global_experiment")
        )
          g.fedcm_button_experiment_arm = _.U(
            "enable_fedcm_button_global_experiment"
          )
            ? 1
            : 0;
        d = _.Yi(g);
        ...
        _.dc !== "warn" && d.set("log_level", _.dc);
        _.Sd(f, d);
        g = _.il();
        f = Rq(h, f.toString(), e, g);
        c.Wa = f.Wa;
        g &&
          f.Yc &&
          rq(f.Yc, function (k) {
      ...
      Fs = function (a, b, c, d) {
        var e = _.Ld(document, "div");
        b.appendChild(e);
        if (Wq(b)) {
          var f = _.N("googleidentityservice_button_styles");
          b = Wq(b);
          f &&
            b &&
      ...
      Gs = function (a, b) {
        _.C("Processing click for button: " + b + ".");
        if (b) {
          var c = _.N(b),
            d = a.H.get(b);
          c ||
          ...
          d
            ? d.va
              ? (d.va(d.data),
                _.C("Custom handler called for button: " + b + "."))
              : ((b = {}),
                d.data.nonce && (b.nonce = d.data.nonce),
                d.data.state && (b.state = d.data.state),
                Is(a, b, d.data ? d.data.sessionId : void 0),
                d.xc && d.xc(Object.assign({}, d.data)))
            : _.F("A button entry was not found for the given id.");
        }
      },
      Is = function (a, b, c) {
        ts(a, !0) && (As(a, "flow_restarted"), Iq("buttonFlowStarted"));
        ...
        ys(a)
          ? ((a.G = !0),
            Or(a.A, {
              ...
              mb: { as: c || a.i, state: b.state, login_uri: a.m.login_uri },
            }))
          : a.T === "redirect"
          ? Js(a, c)
          : Ks(a, c);
      ...
      Js = function (a, b) {
        ...
        b = a.cb ? !1 : _.U("enable_validate_origin_in_redirect_mode");
        if (_.U("enable_gis_oauth_button_flow_redirect")) {
          b = {
            ...
            redirect_uri: b ? _.Nd(a.m.login_uri) : a.m.login_uri,
          ...
          var c = _.qj(new _.Mg(), _.Wi("btn"));
          c = _.Q(c, 4, a.m.g_csrf_token);
          c = _.Q(c, 5, a.m.as);
          c = _.S(c, 7, 2);
          c = _.Q(c, 11, window.location.href);
          _.U("enable_not_setting_client_id_in_transform_layer_payload") ||
            _.pj(_.oj(_.Q(c, 6, a.m.client_id), a.m.origin), a.m.login_uri);
          a.m.state && _.Q(c, 10, a.m.state);
          a.m.library_name && _.Q(c, 12, a.m.library_name);
          b.gis_params = _.Kf(c.g(), 4);
          Dq(
            new Eq(
              "button",
              "redirect",
              "clicked",
              "enable_redirect_uri_validation=" + a.cb
            )
          );
          _.qg(eq(_.Zi(a.Ga, b)));
        } else _.qg(eq(_.Zi(a.Cc, a.m)));
      },
      Ks = function (a, b) {
        a.o = _.Fp();
        a.m.as = b || a.i;
        a.m.channel_id = _.yg(a.o);
        a.m.origin = a.m.origin || location.origin;
        if (_.U("enable_gis_oauth_button_flow_popup")) {
          b = {
            ...
            nonce: a.m.nonce,
            gsiwebsdk: "gis_attributes",
            redirect_uri: _.U("enable_oauth_uri_validation")
              ? "gis_transform"
              : a.m.origin,
            response_mode: "form_post",
            origin: a.m.origin,
          ...
          c = _.Q(c, 5, a.m.as);
          c = _.S(c, 7, 1);
          c = _.Q(c, 8, a.m.channel_id);
          _.U("enable_not_setting_client_id_in_transform_layer_payload") ||
            _.pj(_.oj(_.Q(c, 6, a.m.client_id), a.m.origin), b.redirect_uri);
          a.m.state && _.Q(c, 10, a.m.state);
          a.m.library_name && _.Q(c, 12, a.m.library_name);
          b.gis_params = _.Kf(c.g(), 4);
          c = a.m.client_id;
          ...
          try {
            ...
            _.E("validateTransformLayerPayload failed"), (m = !1);
          }
          m ||
            Dq(
              new Eq(
                ...
                "popup",
                "clicked",
                "base64_gis_params_validation_failed",
                "origin=" + a.m.origin,
                "clientId=" + a.m.client_id,
                "gisParams=" + b.gis_params
              )
            );
          if (_.xc(_.Zi(a.Ga, b), os, _.wc())) return;
          Dq(new Eq("button", "popup", "clicked", "oauthPopupNotOpened"));
        }
        _.xc(_.Zi(a.Cc, a.m), os, _.wc()) ||
          Dq(new Eq("button", "popup", "clicked", "popupNotOpened"));
      },
      ts = function (a, b) {
        if (a.G)
          return (
            (b = a.A),
            _.C("Aborting current FedCM flow."),
            b.g
              ? ((b = b.g),
                _.C("Aborting FedCM flow. callId " + b.g),
                b.h
                  ? (b.h.abort(),
                    _.C("FedCM flow aborted. callId " + b.g),
                    (b.h = void 0),
                    (b = !0))
                  : (_.C("No FedCM flow to abort. callId " + b.g), (b = !1)))
              : (_.C("No FedCM flow to abort."), (b = !1)),
            b ? (vs(a), !0) : !1
          );
        if (Wq(a.container)) var c = !a.I;
        else
          (c = a.container),
            (c = !(
        ...
        Wq(a.container)
          ? ((b = a.I) && b.parentElement
              ? (b.parentElement.id === "credential_picker_container" &&
            ...
            (b = !b))
          : (b = !Oq(a.container));
        if (b) return _.D("Failed to remove prompt iframe."), !1;
        xr(a);
        a.F = !0;
        a.I = void 0;
        vs(a);
    ...
    var Es = function (a, b, c) {
      ...
      Bs = function (a, b) {
        ...
        iq(c, function (d) {
          d && d !== "null"
            ? ((d = Fr(JSON.stringify(_.Ti(d)))), b(d))
            : (_.F("Check credential status returns invalid response."),
              a.j("unknown_reason"),
              _.Yf(a, "network", { cause: "invalid_response" }));
        });
      },
      Cs = function (a) {
        var b = a.m,
        ...
        a.m.channel_id = _.yg(a.o);
        a.m.origin = a.m.origin || location.origin;
        a.m.oauth2_auth_url = a.Ga;
        a.qc && (a.m.library_name = a.qc);
        b = _.Zi(a.Pd, a.m);
        a.F = !0;
        a.Hc(b);
        _.Xf(a, "prompt_displayed");
      };
    qs.prototype.Hc = function (a) {
      this.I = Qq(this.container, a, this.J === "bottom_sheet");
    };
    var Ds = function (a) {
        a.J === "bottom_sheet" &&
          window.setTimeout(function () {
            ts(a, !1) && us(a, "auto_cancel");
          }, a.Od);
      },
      ss = function (a, b) {
        if (b.origin === a.B && b.data && b.data.type === "readyForConnect")
          if (
            (_.C("Setup message received: " + JSON.stringify(b.data)), b.source)
          ) {
            ...
            if (c) {
                  ...
                  if (e.data && e.data.type) {
                    ...
                    if (f !== "command")
                      ...
                      switch (((f = e.data.command), f)) {
                        ...
                        case "resize":
                          f = e.data.iframeId;
                          _.C("Resize command received for button: " + f + ".");
                          if (f) {
                            var g = a.H.get(f),
                              h = e.data.height,
                              k = e.data.width;
              ...
              try {
                ...
                _.F("Failed to send postmessage to iframe: " + e.message);
              }
            }
          } else _.C("Source invalid. Iframe was closed during setup.");
      };
    qs.prototype.Fa = function (a) {
      if (a.data && a.data.type)
        switch (
          (_.C("Message received: " + JSON.stringify(a.data)), a.data.type)
        ) {
          case "response":
            var b = ts(this, !0),
              c = a.data.response,
            ...
            if (d) {
              ...
              this.callback &&
                ...
                _.C("Response received: " + JSON.stringify(c)));
              c = this.m.client_id;
              e = nq();
              if (c && e) {
                f = oq(c);
            ...
            b &&
              (d
                ? As(this, "credential_returned")
                : (us(this, "issuing_failed"), Iq("issuingFailed")),
              xr(this));
            zs(a);
            break;
          case "activity":
            ...
            if ((b = a.data.command))
              switch (b) {
                case "close":
                  a.data.suppress &&
                    ...
                    (b.disable_auto_prompt =
                      new Date().getTime() + Yr[b.prompt_suppress_level] * 1e3),
                    Dq(
                      new Eq(
                        "onetap",
                        void 0,
                    ...
                    bs(a, b));
                  ts(this, !0) && (us(this, "user_cancel"), xr(this));
                  break;
                case "resize":
                  a = a.data.height;
                  if (Sq(a)) {
                    if (this.container !== document.body && Wq(this.container))
                      (b = this.I)
                        ? ((d = b.clientHeight),
                          b.parentElement &&
                ...
                case "start_auto_select":
                  Ls(this, "auto_select_started");
                  break;
                case "cancel_auto_select":
                  qr(this.u), Ls(this, "auto_select_canceled");
              }
        }
    };
    var zs = function (a) {
      a.data.announcement && Vq(a.data.announcement);
    };
    qs.prototype.revoke = function (a, b) {
      var c = { successful: !1 },
        d = this.m.client_id;
      d
        ? _.U("enable_fedcm_revocation_client") &&
          ...
          ? window.IdentityCredential.disconnect({
              ...
              function () {
                c.successful = !0;
                _.D("set result successful to: ' + " + !!c.successful);
                b && b(c);
              },
              function (e) {
                _.F("FedCM disconnect failed with error: " + JSON.stringify(e));
          ...
          : ((a = { client_id: d, hint: a }),
            this.i && (a.as = this.i),
            kq(this.Sd, a, function (e) {
              if (e && e !== "null") {
                if (
                  ((e = Hr(JSON.stringify(_.Ti(e)))),
                  (c.successful = !!_.nj(e, 3)),
                  _.D("Revoke XHR status: " + !!c.successful),
                  !c.successful)
                )
                  if (_.zd(e, _.P, 2)) {
                    e = _.I(e, _.P, 2);
              ...
              } else _.F("Invalid response is returned for revoke request."), (c.error = "invalid_response");
              b && b(c);
            }))
        : (_.F("Failed to revoke. Missing config parameter client_id."),
          b && ((c.error = "missing_client_id"), b(c)));
    };
    var rs = function (a, b, c) {
      (c === void 0 ? 0 : c) &&
        a.O &&
        (b ? a.O.set("ll", b) : a.O.remove("ll"));
      _.Vi(b);
    };
    var ar = {
        client_id: "str",
    ...
    _.G(ir, qs);
    ir.prototype.wc = function (a) {
      this.Z = a.native_callback;
    };
    ir.prototype.j = function (a) {
      _.C("Prompt will not be displayed");
      this.Z && Ms(this);
      qs.prototype.j.call(this, a);
    };
    var Ms = function (a) {
      a.sc ||
        ((a.sc = !0),
    ...
    ir.prototype.ha = function (a, b, c) {
      var d = this;
      this.Y && this.h
        ? (_.C("Verifying parent origin."),
          _.Op(this.h, function () {
            _.Gp
              ? _.Hp({ command: "set_ui_mode", mode: d.J })
              : _.E(
                  "Set ui mode command was not sent due to missing verified parent origin."
                );
            _.Yp(!1);
            d.Ec = !1;
            qs.prototype.ha.call(d, a, b, c);
          }))
        : qs.prototype.ha.call(this, a, b, c);
    };
    ir.prototype.Fa = function (a) {
      qs.prototype.Fa.call(this, a);
        ...
        switch (a.data.type) {
          ...
          case "command":
            switch (a.data.command) {
              case "close":
                this.Ec ? _.Wp(0) : this.gb ? (_.Wp(0), this.gb()) : _.Xp();
                break;
              case "resize":
                a = a.data.height;
                typeof a === "number" && !isNaN(a) && a > 0 && _.Wp(a);
                break;
              case "cancel_protect_start":
                _.Yp(!1);
                break;
    ...
    ir.prototype.Hc = function (a) {
      this.I = Qq(this.container, a, this.J === "bottom_sheet", this.Y);
    };
    ir.prototype.uc = function (a) {
      if (this.Y)
        switch (_.Up) {
    ...
    _.H("google.accounts.id.cancel", function () {
      var a = jr.__G_ID_CLIENT__;
      a && ts(a, !0) && As(a, "cancel_called");
    });
    _.H("google.accounts.id.disableAutoSelect", rr);
    _.H("google.accounts.id.initialize", mr);
    _.H("google.accounts.id.prompt", nr);
    _.H("google.accounts.id.PromptMomentNotification", Xr);
    _.H("google.accounts.id.renderButton", pr);
    _.H("google.accounts.id.revoke", function (a, b) {
      var c = jr.__G_ID_CLIENT__;
      c ? c.revoke(a, b) : _.F("Attempt to call revoke() before initialize().");
    });
    _.H("google.accounts.id.storeCredential", function (a, b) {
      "credentials" in navigator
        ? navigator.credentials
            .store(a)
            .then(function () {
            ...
            .catch(function (c) {
              _.F("Store credential failed: " + JSON.stringify(c));
            })
        : b && b();
    });
    _.H("google.accounts.id.setLogLevel", function (a) {
      var b = jr.__G_ID_CLIENT__;
      b || (mr(), (b = jr.__G_ID_CLIENT__));
      a = a ? a.toLowerCase() : void 0;
      a === void 0 || (0, _.La)(Dr, a) >= 0
        ? rs(b, a, !0)
        : (_.F(
    ...
    var Ns = new _.Gd("g_auth_code_window"),
      Os = function (a) {
        _.Ze.call(this, "code", a);
        this.callback = a.callback;
        this.T = _.tc(a);
        _.D("Instantiated.", "CODE_CLIENT");
      };
    _.G(Os, _.Ze);
    Os.prototype.i = function (a) {
      _.D("Handling response. " + JSON.stringify(a), "CODE_CLIENT");
      _.Ze.prototype.i.call(this, a);
      this.callback && this.callback.call(this, a);
    };
    Os.prototype.requestCode = function () {
      var a = this.s;
      this.T === "redirect"
        ? (_.D("Starting redirect flow.", "CODE_CLIENT"),
          _.rc(window.location, qq(this.j, this.l, a)))
        : (_.D("Starting popup flow.", "CODE_CLIENT"),
          _.$e(this),
          _.af(this, a),
          (this.g = _.xc(qq(this.j, this.l, a), Ns, _.wc())),
          !this.g && this.error_callback
            ? this.error_callback(
                new _.uc("Failed to open popup window", "popup_failed_to_open")
              )
            : _.bf(this));
    };
    var Ps = new _.Gd("g_auth_token_window"),
      Qs = window,
      Rs = function (a) {
        _.Ze.call(this, "token", a);
        this.callback = a.callback;
        _.D("Instantiated.", "TOKEN_CLIENT");
      };
    _.G(Rs, _.Ze);
    Rs.prototype.i = function (a) {
      _.D("Handling response. " + JSON.stringify(a), "TOKEN_CLIENT");
      _.Ze.prototype.i.call(this, a);
      _.D("Trying to set gapi client token.", "TOKEN_CLIENT");
      if (a.access_token)
        if (Qs.gapi && Qs.gapi.client && Qs.gapi.client.setToken)
          try {
            Qs.gapi.client.setToken.call(this, a);
          } catch (b) {
            _.F("Set token failed. Exception encountered.", "TOKEN_CLIENT"),
              console.Ib(b);
          }
        else
          _.D(
        ...
        _.E("Set token failed. No access token in response.", "TOKEN_CLIENT");
      this.callback && this.callback.call(this, a);
    };
    Rs.prototype.requestAccessToken = function (a) {
      ...
      a.enable_granular_consent =
        a.enable_granular_consent === void 0
      ...
      b = _.vc(this.j, {
        ...
        include_granted_scopes:
          a.include_granted_scopes === void 0
      ...
      _.D("Starting popup flow.", "TOKEN_CLIENT");
      _.$e(this);
      _.af(this, b);
      this.g = _.xc(qq(this.j, this.l, b), Ps, _.wc());
      !this.g && this.error_callback
        ? this.error_callback(
            new _.uc("Failed to open popup window", "popup_failed_to_open")
          )
    ...
    _.H("google.accounts.oauth2.GoogleIdentityServicesError", _.uc);
    _.H("google.accounts.oauth2.GoogleIdentityServicesErrorType", {
      ue: "unknown",
      pe: "missing_required_parameter",
      re: "popup_failed_to_open",
      qe: "popup_closed",
    });
    _.H("google.accounts.oauth2.initCodeClient", function (a) {
      return new Os(a);
    });
    _.H("google.accounts.oauth2.CodeClient", Os);
    _.H("google.accounts.oauth2.initTokenClient", function (a) {
      return new Rs(a);
    });
    _.H("google.accounts.oauth2.TokenClient", Rs);
    _.H("google.accounts.oauth2.hasGrantedAllScopes", function (a) {
      var b = Gq.apply(1, arguments),
        c = wr(a);
      return c && c.length
        ? (b = vr.apply(null, Fq(b))) && b.length
          ? (0, _.Qc)(b, function (d) {
              return (0, _.La)(c, d) >= 0;
            })
          : !1
    ...
    _.H("google.accounts.oauth2.hasGrantedAnyScope", function (a) {
      var b = Gq.apply(1, arguments),
        c = wr(a);
      return c && c.length
        ? (b = vr.apply(null, Fq(b))) && b.length
    ...
    _.H("google.accounts.oauth2.revoke", function (a, b) {
      _.C("Revoke request initiated");
      a = { token: a };
      _.C("Making revoke request without credentials.");
      jq("https://oauth2.googleapis.com/revoke", a, !1, function (c) {
        b &&
          (_.D("callback with response: " + c),
          (c = c ? JSON.parse(c) : {}),
